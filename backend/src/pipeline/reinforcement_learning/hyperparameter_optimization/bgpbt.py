...
from .bgpbt_casmo import Casmo4RL, MAX_CHOLESKY_SIZE, MIN_CUDA
from .bgpbt_model import (
    train_gp, is_large,
    get_reward_from_trajectory,
    normalize, copula_standardize,
)


# Adapted from https://github.com/xingchenwan/bgpbt/blob/main/hpo/casmo/bgpbt.py
    ...
    def __init__(self, env, log_dir,
        ...
        if not os.path.exists(checkpoint_dir):
            ...
            try:
                ...
                raise Exception("directories to save checkpoint files do not exist and could not be created")
