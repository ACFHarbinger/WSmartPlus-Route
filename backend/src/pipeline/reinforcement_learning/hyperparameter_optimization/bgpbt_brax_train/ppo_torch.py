...
from .default_configs import BGPBT_ACTIVATIONS
from .linear_schedule import LinearSchedule


# Adapted from https://github.com/xingchenwan/bgpbt/blob/main/custom_brax_train/ppo_torch.py
...
class PPOTrainer:
    ...
    def attach_student(self, params):
        ...
        new_agent = Agent(
            ...
            policy_activation=BGPBT_ACTIVATIONS[params['policy_activation']],
            v_hidden_layer_sizes=params['v_hidden_layer_sizes'],
            value_activation=BGPBT_ACTIVATIONS[params['v_activation']],
