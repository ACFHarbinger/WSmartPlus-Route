...
class TestGenerateData:
    ...
    def test_single_problem_generation(self, gen_data_opts, problem, generator_name, mocker):
        ...
        mock_save = mocker.patch('src.data.generate_data.save_dataset')
        mock_generator = mocker.patch(f'src.data.generate_data.{generator_name}')
    ...
    def test_multiple_sizes_generation(self, gen_data_opts, mocker):
        ...
        mock_generator = mocker.patch('src.data.generate_data.generate_vrp_data')
    ...
    def test_wsr_generation(self, gen_data_opts, mocker):
        ...
        mock_wsr_generator = mocker.patch('src.data.generate_data.generate_wsr_data', return_value=[(mocker_ANY, mocker_ANY)])
