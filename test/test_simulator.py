...
class TestCheckpoints:
    ...
    def test_load_latest_state(self, basic_checkpoint, mocker):
        ...
        mocker.patch('src.pipeline.simulator.checkpoints.os.listdir', return_value=saved_filenames)
        # --------------------------------------------------------
...
class TestLoader:
    ...
    def test_load_depot(self, mock_data_dir, mocker):
        ...
        mocker.patch(
            'src.pipeline.simulator.loader.udef.MAP_DEPOTS',
            {'riomaior': 'RM'}
        )
    ...
    def test_load_indices_file_exists(self, mocker, tmp_path):
        ...
        mocker.patch('src.utils.definitions.ROOT_DIR', str(tmp_path))
...
class TestSimulation:
    ...
    def test__setup_basedata(self, mocker):
        ...
        mocker.patch('src.pipeline.simulator.simulation.load_depot', return_value=mock_depot_df)
    ...
    def test_single_simulation_happy_path_am(
        ...
        mocker.patch(
            'src.pipeline.simulator.checkpoints.SimulationCheckpoint.save_state', 
            autospec=True, 
            return_value=None
        )
        mock_cm = MagicMock()
        ...
        mocker.patch(
            'src.pipeline.simulator.checkpoints.checkpoint_manager',
    ...
    def test_single_simulation_checkpoint_error(
        ...
        mocker.patch(
            'src.pipeline.simulator.simulation.Bins',
        ...
        mocker.patch(
            'src.pipeline.simulator.simulation.checkpoint_manager', 
