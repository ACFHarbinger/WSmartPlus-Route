...
from src.or_policies.look_ahead import policy_lookahead, policy_lookahead_sans, policy_lookahead_vrpp
...
class TestAdvancedLookaheadPolicies:
    ...
    def test_policy_lookahead_sans(self, mocker, mock_vrpp_inputs):
        ...
        mocker.patch('src.or_policies.look_ahead.create_dataframe_from_matrix', return_value=MagicMock())
        mocker.patch('src.or_policies.look_ahead.convert_to_dict', return_value=MagicMock())
        mocker.patch('src.or_policies.look_ahead.compute_initial_solution', return_value=[])
        
        # Mock the core Simulated Annealing engine
        mock_annealing = mocker.patch(
            'src.or_policies.look_ahead.improved_simulated_annealing',
        ...
        mocker.patch('src.pipeline.simulator.loader.load_area_and_waste_type_params', 
...
class TestGurobiOptimizer:
    ...
    def test_policy_gurobi_must_go_selection(self, mocker, mock_optimizer_data):
        ...
        """
        # --- Arrange ---
        from src.or_policies.gurobi_optimizer import policy_gurobi_vrpp
        ...
        mocker.patch('src.or_policies.gurobi_optimizer.policy_gurobi_vrpp', side_effect=mock_gurobi_solution_routes, autospec=True)
...
class TestHexalyOptimizer:
    ...
    def test_policy_hexaly_must_go_selection(self, mocker, mock_optimizer_data):
        ...
        """
        # --- Arrange ---
        from src.or_policies.hexaly_optimizer import policy_hexaly_vrpp
