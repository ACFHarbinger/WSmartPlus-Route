...
def run_all_tsiligirides(dataset_path, sample, num_samples, eval_batch_size, max_calc_batch_size, 
                        no_cuda=False, dataset_n=None, progress_bar_mininterval=0.1, seed=1234):
    import torch
    ...
    for dataset_path in opts.datasets:
        ...
        if opts.o is None:
            ...
            try:
                ...
                raise Exception("directories to save OP files do not exist and could not be created")
        ...
        if method == "tsili" or method == "tsiligreedy":
            ...
            if not os.path.isdir(target_dir):
                try:
                    ...
                    raise Exception("target directory does not exist and could not be created")
