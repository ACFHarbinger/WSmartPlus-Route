...
import { RuntimeAttentionPanel } from "../../analysis/topology/RuntimeAttentionPanel";
import { TrainingHealthPanel } from "../../analysis/training/TrainingHealthPanel";
import {
  GradNormSparkline,
  LrSparkline,
  TrainingMetricSnapshot,
} from "./TrainingMetricSparklines";
import { postRunTrainingRehydrationMessage } from "../../../utils/training/trainingMetrics";
import type {
  AttentionVizEntry,
  TrainingHealthEntry,
  TrainingMetricsRow,
