...
from app.src.pipeline.simulator.day import run_day
from app.src.or_policies.regular import policy_regular
from app.src.or_policies.last_minute import policy_last_minute, policy_last_minute_and_path
from app.src.or_policies.look_ahead import policy_lookahead, policy_lookahead_sans, policy_lookahead_vrpp
...
class TestGurobiOptimizer:
    ...
    def test_policy_gurobi_must_go_selection(self, mocker, mock_optimizer_data):
        ...
        """
        # --- Arrange ---
        from app.src.or_policies.gurobi_optimizer import policy_gurobi_vrpp
