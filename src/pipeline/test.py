...
from src.pipeline.simulator.loader import load_indices
from src.pipeline.simulator.simulation import (
...
def simulator_testing(opts, data_size, device):
    ...
    realtime_log_path = os.path.join(udef.ROOT_DIR, "assets", opts['output_dir'], 
