...
from src.gui.tabs.test_simulator.ts_settings import TestSimSettingsTab
from src.gui.tabs.test_simulator.ts_input_output import TestSimIOTab
from src.gui.tabs.test_simulator.ts_policy_parameters import TestSimPolicyParamsTab
