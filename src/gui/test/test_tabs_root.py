...
import pytest
from src.gui.tabs.hyperparam_optim import HyperParamOptimParserTab
from src.gui.tabs.meta_rl_train import MetaRLTrainParserTab
from src.gui.tabs.scripts import RunScriptsTab
from src.gui.tabs.test_suite import TestSuiteTab
