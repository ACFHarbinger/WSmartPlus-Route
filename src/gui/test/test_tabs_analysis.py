...
from src.gui.tabs.analysis.input_analysis import InputAnalysisTab
from src.gui.tabs.analysis.output_analysis import OutputAnalysisTab
from src.gui.test.conftest import MockDataLoadWorker

# Mock DataLoadWorker where it is imported in input_analysis
@patch('src.gui.tabs.analysis.input_analysis.DataLoadWorker', new=MockDataLoadWorker)
