...
class GenDataGeneralTab(QWidget):
    ...
    def __init__(self):
        ...
        self.filename_header_widget.setStyleSheet("QWidget { border: none; padding: 0; margin-top: 5px; }")
        ...
        self.filename_label.setSizePolicy(QSizePolicy.Policy.Fixed, QSizePolicy.Policy.Preferred)
        ...
        filename_layout.addRow(
            QLabel("Specific Filename:"),
            self._create_browser_layout(self.filename_input),
        )
        ...
        layout.addRow(
            "Data Directory:",
            self._create_browser_layout(self.data_dir_input, is_dir=True),
        )
    ...
    def _toggle_filename(self):
        ...
        if self.is_filename_visible:
            ...
            self.filename_label.setStyleSheet("QLabel { border: none; padding: 5px; background-color: transparent; }")
