...
class FileSystemCryptographyTab(QWidget):
    ...
    def __init__(self):
        ...
        self.input_output_header_widget.setStyleSheet("QWidget { border: none; padding: 0; margin-top: 5px; }")
        ...
        self.input_output_label.setSizePolicy(QSizePolicy.Policy.Fixed, QSizePolicy.Policy.Preferred)
