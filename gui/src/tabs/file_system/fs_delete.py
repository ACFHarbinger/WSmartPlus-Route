...
class FileSystemDeleteTab(QWidget):
    ...
    def __init__(self):
        ...
        path_layout.addRow(
            "Train Log Directory:",
            self._create_browser_layout(self.log_dir_input, is_dir=True),
        )
        ...
        path_layout.addRow(
            ...
            self._create_browser_layout(self.eval_dir_input, is_dir=True),
        )

        self.test_dir_input = QLineEdit("output")
        path_layout.addRow(
            "WSR Test Output Directory:",
            self._create_browser_layout(self.test_dir_input, is_dir=True),
        )

        self.test_checkpoint_dir_input = QLineEdit("temp")
        path_layout.addRow(
            "WSR Checkpoint Directory:",
            self._create_browser_layout(self.test_checkpoint_dir_input, is_dir=True),
        )
