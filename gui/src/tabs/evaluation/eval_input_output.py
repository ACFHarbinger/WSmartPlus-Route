...
class EvalIOTab(QWidget):
    ...
    def __init__(self):
        ...
        self.output_file_header_widget.setStyleSheet("QWidget { border: none; padding: 0; margin-top: 5px; }")
        ...
        self.output_file_label.setSizePolicy(QSizePolicy.Policy.Fixed, QSizePolicy.Policy.Preferred)
