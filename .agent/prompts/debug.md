...
- Do not suggest manual `.to('cuda')` calls. You MUST use the project's standard `logic/src/utils/infrastructure/setup_sims.py` or existing device properties in `logic/src/utils/definitions.py`.
