...
- **GPU Utilization**: Verify that tensors are explicitly moved to the correct device using `logic/src/utils/infrastructure/setup_sims.py` to support target RTX 4080/3090ti hardware.
...
- **Example**: Code snippet showing the fix (especially for `setup_sims.py` or `boolmask.py` usage).
