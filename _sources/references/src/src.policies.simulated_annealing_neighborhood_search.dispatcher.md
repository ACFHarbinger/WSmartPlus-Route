# {py:mod}`src.policies.simulated_annealing_neighborhood_search.dispatcher`

```{py:module} src.policies.simulated_annealing_neighborhood_search.dispatcher
```

```{autodoc2-docstring} src.policies.simulated_annealing_neighborhood_search.dispatcher
:allowtitles:
```
...
* - {py:obj}`execute_new <src.policies.simulated_annealing_neighborhood_search.dispatcher.execute_new>`
  - ```{autodoc2-docstring} src.policies.simulated_annealing_neighborhood_search.dispatcher.execute_new
    :summary:
    ```
* - {py:obj}`execute_og <src.policies.simulated_annealing_neighborhood_search.dispatcher.execute_og>`
