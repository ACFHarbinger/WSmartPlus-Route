...
````{py:method} select_action(static, dynamic, global_features=None, deterministic=False, threshold=0.5, mandatory_threshold=0.5, target_mandatory=None)
...
````{py:method} get_mandatory_mask(static, dynamic, global_features=None, threshold=0.5)
