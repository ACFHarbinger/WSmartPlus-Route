...
* - {py:obj}`_try_5opt_move <src.policies.lin_kernighan_helsgaun_three.tour_improvement._try_5opt_move>`
  - ```{autodoc2-docstring} src.policies.lin_kernighan_helsgaun_three.tour_improvement._try_5opt_move
    :summary:
    ```
* - {py:obj}`__or_opt_relocation <src.policies.lin_kernighan_helsgaun_three.tour_improvement.__or_opt_relocation>`
  - ```{autodoc2-docstring} src.policies.lin_kernighan_helsgaun_three.tour_improvement.__or_opt_relocation
    :summary:
    ```
* - {py:obj}`_try_oropt_move <src.policies.lin_kernighan_helsgaun_three.tour_improvement._try_oropt_move>`
  - ```{autodoc2-docstring} src.policies.lin_kernighan_helsgaun_three.tour_improvement._try_oropt_move
    :summary:
    ```
* - {py:obj}`_dynamic_kopt_search <src.policies.lin_kernighan_helsgaun_three.tour_improvement._dynamic_kopt_search>`
  - ```{autodoc2-docstring} src.policies.lin_kernighan_helsgaun_three.tour_improvement._dynamic_kopt_search
    :summary:
    ```
* - {py:obj}`_verify_and_construct <src.policies.lin_kernighan_helsgaun_three.tour_improvement._verify_and_construct>`
  - ```{autodoc2-docstring} src.policies.lin_kernighan_helsgaun_three.tour_improvement._verify_and_construct
    :summary:
    ```
````
...
:canonical: src.policies.lin_kernighan_helsgaun_three.tour_improvement.__or_opt_relocation
...
:canonical: src.policies.lin_kernighan_helsgaun_three.tour_improvement._try_oropt_move
...
:canonical: src.policies.lin_kernighan_helsgaun_three.tour_improvement._dynamic_kopt_search
...
:canonical: src.policies.lin_kernighan_helsgaun_three.tour_improvement._verify_and_construct
