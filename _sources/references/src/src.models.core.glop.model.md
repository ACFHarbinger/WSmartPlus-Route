...
`````{py:class} GLOP(env: logic.src.envs.base.RL4COEnvBase, policy: typing.Optional[src.models.core.glop.policy.GLOPPolicy] = None, policy_kwargs: typing.Optional[typing.Dict[str, typing.Any]] = None, baseline: str = 'mean', **kwargs)
