# {py:mod}`src.models.core.n2s.encoder`

```{py:module} src.models.core.n2s.encoder
```

```{autodoc2-docstring} src.models.core.n2s.encoder
:allowtitles:
```
...
* - {py:obj}`N2SEncoder <src.models.core.n2s.encoder.N2SEncoder>`
  - ```{autodoc2-docstring} src.models.core.n2s.encoder.N2SEncoder
    :summary:
    ```
````
...
```{autodoc2-docstring} src.models.core.n2s.encoder.N2SEncoder.__init__
```

````{py:method} _get_neighborhood_mask(td: tensordict.TensorDict) -> torch.Tensor
:canonical: src.models.core.n2s.encoder.N2SEncoder._get_neighborhood_mask

```{autodoc2-docstring} src.models.core.n2s.encoder.N2SEncoder._get_neighborhood_mask
```
