# {py:mod}`src.utils.functions.boolmask`

```{py:module} src.utils.functions.boolmask
```

```{autodoc2-docstring} src.utils.functions.boolmask
:allowtitles:
```
...
* - {py:obj}`_pad_mask <src.utils.functions.boolmask._pad_mask>`
  - ```{autodoc2-docstring} src.utils.functions.boolmask._pad_mask
    :summary:
    ```
* - {py:obj}`_mask_bool2byte <src.utils.functions.boolmask._mask_bool2byte>`
  - ```{autodoc2-docstring} src.utils.functions.boolmask._mask_bool2byte
    :summary:
    ```
* - {py:obj}`_mask_byte2long <src.utils.functions.boolmask._mask_byte2long>`
  - ```{autodoc2-docstring} src.utils.functions.boolmask._mask_byte2long
    :summary:
    ```
* - {py:obj}`mask_bool2long <src.utils.functions.boolmask.mask_bool2long>`
  - ```{autodoc2-docstring} src.utils.functions.boolmask.mask_bool2long
    :summary:
    ```
* - {py:obj}`_mask_long2byte <src.utils.functions.boolmask._mask_long2byte>`
  - ```{autodoc2-docstring} src.utils.functions.boolmask._mask_long2byte
    :summary:
    ```
* - {py:obj}`_mask_byte2bool <src.utils.functions.boolmask._mask_byte2bool>`
  - ```{autodoc2-docstring} src.utils.functions.boolmask._mask_byte2bool
    :summary:
    ```
* - {py:obj}`mask_long2bool <src.utils.functions.boolmask.mask_long2bool>`
  - ```{autodoc2-docstring} src.utils.functions.boolmask.mask_long2bool
    :summary:
    ```
* - {py:obj}`mask_long_scatter <src.utils.functions.boolmask.mask_long_scatter>`
