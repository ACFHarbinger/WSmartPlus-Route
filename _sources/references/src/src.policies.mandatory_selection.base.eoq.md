# {py:mod}`src.policies.mandatory_selection.base.eoq`

```{py:module} src.policies.mandatory_selection.base.eoq
```

```{autodoc2-docstring} src.policies.mandatory_selection.base.eoq
:allowtitles:
```
...
* - {py:obj}`compute_eoq_thresholds <src.policies.mandatory_selection.base.eoq.compute_eoq_thresholds>`
  - ```{autodoc2-docstring} src.policies.mandatory_selection.base.eoq.compute_eoq_thresholds
    :summary:
    ```
* - {py:obj}`resolve_trigger_threshold <src.policies.mandatory_selection.base.eoq.resolve_trigger_threshold>`
