# {py:mod}`src.policies.route_construction.learning_matheuristic_algorithms.learning_allocated_sequential_matheuristic`

```{py:module} src.policies.route_construction.learning_matheuristic_algorithms.learning_allocated_sequential_matheuristic
```

```{autodoc2-docstring} src.policies.route_construction.learning_matheuristic_algorithms.learning_allocated_sequential_matheuristic
:allowtitles:
```
...
* - {py:obj}`__all__ <src.policies.route_construction.learning_matheuristic_algorithms.learning_allocated_sequential_matheuristic.__all__>`
