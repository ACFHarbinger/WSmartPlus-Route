# {py:mod}`src.policies.branch_and_price`

```{py:module} src.policies.branch_and_price
```

```{autodoc2-docstring} src.policies.branch_and_price
:allowtitles:
```
...
* - {py:obj}`__all__ <src.policies.branch_and_price.__all__>`
