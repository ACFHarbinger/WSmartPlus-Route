# {py:mod}`src.tracking.logging.logger_writer`

```{py:module} src.tracking.logging.logger_writer
```

```{autodoc2-docstring} src.tracking.logging.logger_writer
:allowtitles:
```
...
* - {py:obj}`LoggerWriter <src.tracking.logging.logger_writer.LoggerWriter>`
...
* - {py:obj}`setup_logger_redirection <src.tracking.logging.logger_writer.setup_logger_redirection>`
  - ```{autodoc2-docstring} src.tracking.logging.logger_writer.setup_logger_redirection
    :summary:
    ```
````
...
````{py:function} setup_logger_redirection(log_file: typing.Optional[str] = None, silent: bool = False, redirect_stdout: bool = True, redirect_stderr: bool = True, echo_to_terminal: bool = False) -> str
:canonical: src.tracking.logging.logger_writer.setup_logger_redirection
