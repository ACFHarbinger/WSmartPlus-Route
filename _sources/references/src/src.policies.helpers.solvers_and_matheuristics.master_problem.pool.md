# {py:mod}`src.policies.helpers.solvers_and_matheuristics.master_problem.pool`

```{py:module} src.policies.helpers.solvers_and_matheuristics.master_problem.pool
```

```{autodoc2-docstring} src.policies.helpers.solvers_and_matheuristics.master_problem.pool
:allowtitles:
```
...
```{autodoc2-docstring} src.policies.helpers.solvers_and_matheuristics.master_problem.pool.GlobalCutPool.__init__
```
