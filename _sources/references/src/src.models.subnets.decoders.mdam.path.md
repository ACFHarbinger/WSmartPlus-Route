...
````{py:method} precompute(h_embed: torch.Tensor, num_steps: int = 1) -> logic.src.models.subnets.decoders.common.AttentionDecoderCache
...
````{py:method} get_logprobs(fixed: logic.src.models.subnets.decoders.common.AttentionDecoderCache, td: tensordict.TensorDict, dynamic_embed: typing.Tuple[torch.Tensor, torch.Tensor, torch.Tensor], path_index: int) -> typing.Tuple[torch.Tensor, typing.Optional[torch.Tensor]]
