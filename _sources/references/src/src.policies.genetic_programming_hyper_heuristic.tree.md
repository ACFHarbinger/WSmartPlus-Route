...
````{py:function} _random_tree(depth: int, n_llh: int) -> src.policies.genetic_programming_hyper_heuristic.tree.GPNode
...
````{py:function} _subtree_crossover(t1: src.policies.genetic_programming_hyper_heuristic.tree.GPNode, t2: src.policies.genetic_programming_hyper_heuristic.tree.GPNode) -> typing.Tuple[src.policies.genetic_programming_hyper_heuristic.tree.GPNode, src.policies.genetic_programming_hyper_heuristic.tree.GPNode]
...
````{py:function} _mutate(tree: src.policies.genetic_programming_hyper_heuristic.tree.GPNode, depth: int, n_llh: int) -> src.policies.genetic_programming_hyper_heuristic.tree.GPNode
