...
```{autodoc2-docstring} src.policies.route_construction.meta_heuristics.reactive_tabu_search.policy_rts.RTSPolicy._config_class
```
...
```{autodoc2-docstring} src.policies.route_construction.meta_heuristics.reactive_tabu_search.policy_rts.RTSPolicy._get_config_key
```
