# {py:mod}`src.utils.input.file_processing`

```{py:module} src.utils.input.file_processing
```

```{autodoc2-docstring} src.utils.input.file_processing
:allowtitles:
```
...
* - {py:obj}`process_pattern_files <src.utils.input.file_processing.process_pattern_files>`
  - ```{autodoc2-docstring} src.utils.input.file_processing.process_pattern_files
    :summary:
    ```
* - {py:obj}`process_file <src.utils.input.file_processing.process_file>`
  - ```{autodoc2-docstring} src.utils.input.file_processing.process_file
    :summary:
    ```
````
...
:canonical: src.utils.input.file_processing.process_pattern_files
...
:canonical: src.utils.input.file_processing.process_file
