# {py:mod}`src.policies.route_construction.other_algorithms.capacitated_vehicle_routing_problem`

```{py:module} src.policies.route_construction.other_algorithms.capacitated_vehicle_routing_problem
```

```{autodoc2-docstring} src.policies.route_construction.other_algorithms.capacitated_vehicle_routing_problem
:allowtitles:
```
