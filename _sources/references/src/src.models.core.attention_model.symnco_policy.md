# {py:mod}`src.models.core.attention_model.symnco_policy`

```{py:module} src.models.core.attention_model.symnco_policy
```

```{autodoc2-docstring} src.models.core.attention_model.symnco_policy
:allowtitles:
```
...
* - {py:obj}`SymNCOPolicy <src.models.core.attention_model.symnco_policy.SymNCOPolicy>`
  - ```{autodoc2-docstring} src.models.core.attention_model.symnco_policy.SymNCOPolicy
    :summary:
    ```
````
