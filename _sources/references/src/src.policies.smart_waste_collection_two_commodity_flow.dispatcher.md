...
````{py:function} run_swc_tcf_optimizer(bins: numpy.typing.NDArray[numpy.float64], distance_matrix: typing.List[typing.List[float]], param: float, media: numpy.typing.NDArray[numpy.float64], desviopadrao: numpy.typing.NDArray[numpy.float64], values: typing.Dict[str, float], binsids: typing.List[int], must_go: typing.List[int], env: typing.Optional[gurobipy.Env] = None, number_vehicles: int = 1, time_limit: int = 60, optimizer: str = 'gurobi', seed: int = 42, max_iter_no_improv: int = 10)
