...
```{autodoc2-docstring} src.policies.route_construction.meta_heuristics.differential_evolution.policy_de.DEPolicyAdapter._config_class
```
...
```{autodoc2-docstring} src.policies.route_construction.meta_heuristics.differential_evolution.policy_de.DEPolicyAdapter._get_config_key
```
