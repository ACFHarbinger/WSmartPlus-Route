...
* - {py:obj}`_get_farthest_node <src.policies.other.operators.repair.farthest._get_farthest_node>`
  - ```{autodoc2-docstring} src.policies.other.operators.repair.farthest._get_farthest_node
    :summary:
    ```
* - {py:obj}`_find_cheapest_insertion <src.policies.other.operators.repair.farthest._find_cheapest_insertion>`
  - ```{autodoc2-docstring} src.policies.other.operators.repair.farthest._find_cheapest_insertion
    :summary:
    ```
* - {py:obj}`_find_nearest_insertion <src.policies.other.operators.repair.farthest._find_nearest_insertion>`
  - ```{autodoc2-docstring} src.policies.other.operators.repair.farthest._find_nearest_insertion
    :summary:
    ```
...
:canonical: src.policies.other.operators.repair.farthest._get_farthest_node
...
:canonical: src.policies.other.operators.repair.farthest._find_nearest_insertion
