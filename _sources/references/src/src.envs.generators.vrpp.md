...
`````{py:class} VRPPGenerator(num_loc: int = 50, min_loc: float = 0.0, max_loc: float = 1.0, loc_distribution: typing.Union[str, typing.Callable] = 'uniform', min_waste: float = 0.0, max_waste: float = 1.0, waste_distribution: str = 'uniform', capacity: float = 1.0, max_length: typing.Optional[float] = None, depot_type: str = 'center', device: typing.Union[str, torch.device] = 'cpu', **kwargs: typing.Any)
