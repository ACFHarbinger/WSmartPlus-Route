...
`````{py:class} ACOLocalSearch(dist_matrix: numpy.ndarray, waste: typing.Dict[int, float], capacity: float, R: float, C: float, params: typing.Any, seed: typing.Optional[int] = None, neighbors: typing.Optional[typing.Dict[int, typing.List[int]]] = None)
