# {py:mod}`src.policies.particle_swarm_optimization_memetic_algorithm`

```{py:module} src.policies.particle_swarm_optimization_memetic_algorithm
```

```{autodoc2-docstring} src.policies.particle_swarm_optimization_memetic_algorithm
:allowtitles:
```
