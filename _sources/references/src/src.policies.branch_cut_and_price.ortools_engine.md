# {py:mod}`src.policies.branch_cut_and_price.ortools_engine`

```{py:module} src.policies.branch_cut_and_price.ortools_engine
```

```{autodoc2-docstring} src.policies.branch_cut_and_price.ortools_engine
:allowtitles:
```
...
* - {py:obj}`run_bcp_ortools <src.policies.branch_cut_and_price.ortools_engine.run_bcp_ortools>`
  - ```{autodoc2-docstring} src.policies.branch_cut_and_price.ortools_engine.run_bcp_ortools
    :summary:
    ```
* - {py:obj}`_add_distance_constraints <src.policies.branch_cut_and_price.ortools_engine._add_distance_constraints>`
  - ```{autodoc2-docstring} src.policies.branch_cut_and_price.ortools_engine._add_distance_constraints
    :summary:
    ```
* - {py:obj}`_add_capacity_constraints <src.policies.branch_cut_and_price.ortools_engine._add_capacity_constraints>`
...
* - {py:obj}`_get_search_parameters <src.policies.branch_cut_and_price.ortools_engine._get_search_parameters>`
  - ```{autodoc2-docstring} src.policies.branch_cut_and_price.ortools_engine._get_search_parameters
    :summary:
    ```
* - {py:obj}`_parse_routes <src.policies.branch_cut_and_price.ortools_engine._parse_routes>`
  - ```{autodoc2-docstring} src.policies.branch_cut_and_price.ortools_engine._parse_routes
    :summary:
    ```
* - {py:obj}`_calculate_real_cost <src.policies.branch_cut_and_price.ortools_engine._calculate_real_cost>`
  - ```{autodoc2-docstring} src.policies.branch_cut_and_price.ortools_engine._calculate_real_cost
    :summary:
    ```
````
...
:canonical: src.policies.branch_cut_and_price.ortools_engine._add_distance_constraints
...
:canonical: src.policies.branch_cut_and_price.ortools_engine._parse_routes
...
:canonical: src.policies.branch_cut_and_price.ortools_engine._calculate_real_cost
