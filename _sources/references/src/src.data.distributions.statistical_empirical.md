...
:canonical: src.data.distributions.statistical_empirical.Empirical.sample_tensor

```{autodoc2-docstring} src.data.distributions.statistical_empirical.Empirical.sample_tensor
```

````

````{py:method} sample_array(size: typing.Tuple[int, ...]) -> numpy.ndarray
:canonical: src.data.distributions.statistical_empirical.Empirical.sample_array

```{autodoc2-docstring} src.data.distributions.statistical_empirical.Empirical.sample_array
```
