...
````{py:function} _evaluate_move(routes_list, idx_route, position, bin_to_move, previous_solution, previous_profit, p_vehicle, p_load, p_route_difference, p_shift, data, distance_matrix, values)
