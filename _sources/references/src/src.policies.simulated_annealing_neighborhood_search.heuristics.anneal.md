...
````{py:function} run_annealing_loop(initial_solution: typing.List[typing.List[int]], data: pandas.DataFrame, distance_matrix: numpy.ndarray, must_go_bins: typing.List[int], values: typing.Dict, n_bins: int, chosen_combination: typing.Tuple, time_limit: float, rng: random.Random, np_rng: numpy.random.Generator) -> typing.Tuple[typing.List[typing.List[int]], typing.List[int]]
