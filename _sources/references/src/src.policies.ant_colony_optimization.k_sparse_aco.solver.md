...
`````{py:class} KSparseACOSolver(dist_matrix: numpy.ndarray, wastes: typing.Dict[int, float], capacity: float, R: float, C: float, params: src.policies.ant_colony_optimization.k_sparse_aco.params.ACOParams, mandatory_nodes: typing.Optional[typing.List[int]] = None)
