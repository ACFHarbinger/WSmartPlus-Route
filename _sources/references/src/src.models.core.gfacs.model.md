# {py:mod}`src.models.core.gfacs.model`

```{py:module} src.models.core.gfacs.model
```

```{autodoc2-docstring} src.models.core.gfacs.model
:allowtitles:
```
...
* - {py:obj}`GFACS <src.models.core.gfacs.model.GFACS>`
  - ```{autodoc2-docstring} src.models.core.gfacs.model.GFACS
    :summary:
    ```
````
...
````{py:property} alpha
:canonical: src.models.core.gfacs.model.GFACS.alpha
:type: float

```{autodoc2-docstring} src.models.core.gfacs.model.GFACS.alpha
```

````

````{py:property} beta
:canonical: src.models.core.gfacs.model.GFACS.beta
:type: float

```{autodoc2-docstring} src.models.core.gfacs.model.GFACS.beta
```
...
:canonical: src.models.core.gfacs.model.GFACS.calculate_loss

```{autodoc2-docstring} src.models.core.gfacs.model.GFACS.calculate_loss
```

````

````{py:method} calculate_log_pb_uniform(actions: torch.Tensor, n_ants: int) -> torch.Tensor
:canonical: src.models.core.gfacs.model.GFACS.calculate_log_pb_uniform

```{autodoc2-docstring} src.models.core.gfacs.model.GFACS.calculate_log_pb_uniform
```
