# {py:mod}`src.policies.route_construction.learning_algorithms.neural_agent`

```{py:module} src.policies.route_construction.learning_algorithms.neural_agent
```

```{autodoc2-docstring} src.policies.route_construction.learning_algorithms.neural_agent
:allowtitles:
```
...
* - {py:obj}`__all__ <src.policies.route_construction.learning_algorithms.neural_agent.__all__>`
