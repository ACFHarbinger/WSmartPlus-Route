# {py:mod}`src.pipeline.simulations.wsmart_bin_analysis.Deliverables`

```{py:module} src.pipeline.simulations.wsmart_bin_analysis.Deliverables
```

```{autodoc2-docstring} src.pipeline.simulations.wsmart_bin_analysis.Deliverables
:allowtitles:
```
