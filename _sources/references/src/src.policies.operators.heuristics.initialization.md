# {py:mod}`src.policies.operators.heuristics.initialization`

```{py:module} src.policies.operators.heuristics.initialization
```

```{autodoc2-docstring} src.policies.operators.heuristics.initialization
:allowtitles:
```
...
* - {py:obj}`build_nn_routes <src.policies.operators.heuristics.initialization.build_nn_routes>`
