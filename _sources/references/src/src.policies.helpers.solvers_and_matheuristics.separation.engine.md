# {py:mod}`src.policies.helpers.solvers_and_matheuristics.separation.engine`

```{py:module} src.policies.helpers.solvers_and_matheuristics.separation.engine
```

```{autodoc2-docstring} src.policies.helpers.solvers_and_matheuristics.separation.engine
:allowtitles:
```
...
* - {py:obj}`SeparationEngine <src.policies.helpers.solvers_and_matheuristics.separation.engine.SeparationEngine>`
  - ```{autodoc2-docstring} src.policies.helpers.solvers_and_matheuristics.separation.engine.SeparationEngine
    :summary:
    ```
````
...
:canonical: src.policies.helpers.solvers_and_matheuristics.separation.engine.SeparationEngine
...
```{autodoc2-docstring} src.policies.helpers.solvers_and_matheuristics.separation.engine.SeparationEngine._EXACT_SEP_PERIOD
```

````

````{py:method} separate_integer(x_vals: numpy.ndarray, y_vals: typing.Optional[numpy.ndarray] = None, max_cuts: int = 100, iteration: int = 0, sec_only: bool = False) -> typing.List[logic.src.policies.helpers.solvers_and_matheuristics.separation.inequality.Inequality]
:canonical: src.policies.helpers.solvers_and_matheuristics.separation.engine.SeparationEngine.separate_integer

```{autodoc2-docstring} src.policies.helpers.solvers_and_matheuristics.separation.engine.SeparationEngine.separate_integer
```

````

````{py:method} separate_fractional(x_vals: numpy.ndarray, y_vals: typing.Optional[numpy.ndarray] = None, max_cuts: int = 50, iteration: int = 0, node_count: int = 0) -> typing.List[logic.src.policies.helpers.solvers_and_matheuristics.separation.inequality.Inequality]
...
:canonical: src.policies.helpers.solvers_and_matheuristics.separation.engine.SeparationEngine._get_cut_value

```{autodoc2-docstring} src.policies.helpers.solvers_and_matheuristics.separation.engine.SeparationEngine._get_cut_value
```
...
:canonical: src.policies.helpers.solvers_and_matheuristics.separation.engine.SeparationEngine._refine_pcsec_build

```{autodoc2-docstring} src.policies.helpers.solvers_and_matheuristics.separation.engine.SeparationEngine._refine_pcsec_build
```
