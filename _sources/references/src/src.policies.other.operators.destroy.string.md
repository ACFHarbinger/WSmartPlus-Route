...
* - {py:obj}`_sisr_ruin_pass <src.policies.other.operators.destroy.string._sisr_ruin_pass>`
  - ```{autodoc2-docstring} src.policies.other.operators.destroy.string._sisr_ruin_pass
    :summary:
    ```
...
:canonical: src.policies.other.operators.destroy.string._sisr_ruin_pass
