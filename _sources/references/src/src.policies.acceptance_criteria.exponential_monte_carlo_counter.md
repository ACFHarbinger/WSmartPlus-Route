...
```{autodoc2-docstring} src.policies.acceptance_criteria.exponential_monte_carlo_counter.EMCQAcceptance.setup
```
...
```{autodoc2-docstring} src.policies.acceptance_criteria.exponential_monte_carlo_counter.EMCQAcceptance.accept
```
...
```{autodoc2-docstring} src.policies.acceptance_criteria.exponential_monte_carlo_counter.EMCQAcceptance.step
```
...
```{autodoc2-docstring} src.policies.acceptance_criteria.exponential_monte_carlo_counter.EMCQAcceptance.get_state
```
