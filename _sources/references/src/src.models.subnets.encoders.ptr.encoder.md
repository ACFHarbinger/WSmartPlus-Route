# {py:mod}`src.models.subnets.encoders.ptr.encoder`

```{py:module} src.models.subnets.encoders.ptr.encoder
```

```{autodoc2-docstring} src.models.subnets.encoders.ptr.encoder
:allowtitles:
```
...
* - {py:obj}`PointerEncoder <src.models.subnets.encoders.ptr.encoder.PointerEncoder>`
  - ```{autodoc2-docstring} src.models.subnets.encoders.ptr.encoder.PointerEncoder
    :summary:
    ```
````
