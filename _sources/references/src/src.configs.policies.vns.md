...
````{py:attribute} seed
:canonical: src.configs.policies.vns.VNSConfig.seed
:type: typing.Optional[int]
:value: >
   None

```{autodoc2-docstring} src.configs.policies.vns.VNSConfig.seed
```
...
:canonical: src.configs.policies.vns.VNSConfig.profit_aware_operators
:type: bool
:value: >
   False

```{autodoc2-docstring} src.configs.policies.vns.VNSConfig.profit_aware_operators
```
...
:canonical: src.configs.policies.vns.VNSConfig.acceptance_criterion
:type: logic.src.configs.policies.other.acceptance_criteria.AcceptanceConfig
:value: >
   'field(...)'

```{autodoc2-docstring} src.configs.policies.vns.VNSConfig.acceptance_criterion
```
