...
```{autodoc2-docstring} src.policies.route_construction.matheuristics.cluster_first_route_second.policy_cf_rs.ClusterFirstRouteSecondPolicy._config_class
```
...
```{autodoc2-docstring} src.policies.route_construction.matheuristics.cluster_first_route_second.policy_cf_rs.ClusterFirstRouteSecondPolicy._get_config_key
```
