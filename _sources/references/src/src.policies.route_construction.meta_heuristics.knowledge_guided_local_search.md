# {py:mod}`src.policies.route_construction.meta_heuristics.knowledge_guided_local_search`

```{py:module} src.policies.route_construction.meta_heuristics.knowledge_guided_local_search
```

```{autodoc2-docstring} src.policies.route_construction.meta_heuristics.knowledge_guided_local_search
:allowtitles:
```
