# {py:mod}`src.policies.route_construction.exact_and_decomposition_solvers.branch_and_bound`

```{py:module} src.policies.route_construction.exact_and_decomposition_solvers.branch_and_bound
```

```{autodoc2-docstring} src.policies.route_construction.exact_and_decomposition_solvers.branch_and_bound
:allowtitles:
```
...
* - {py:obj}`__all__ <src.policies.route_construction.exact_and_decomposition_solvers.branch_and_bound.__all__>`
  - ```{autodoc2-docstring} src.policies.route_construction.exact_and_decomposition_solvers.branch_and_bound.__all__
    :summary:
    ```
````
...
````{py:data} __all__
:canonical: src.policies.route_construction.exact_and_decomposition_solvers.branch_and_bound.__all__
:value: >
