...
`````{py:class} SASolver(dist_matrix: numpy.ndarray, wastes: typing.Dict[int, float], capacity: float, R: float, C: float, params: src.policies.simulated_annealing.params.SAParams, mandatory_nodes: typing.Optional[typing.List[int]] = None)
