# {py:mod}`src.models.policies.operators.destroy.worst_removal`

```{py:module} src.models.policies.operators.destroy.worst_removal
```

```{autodoc2-docstring} src.models.policies.operators.destroy.worst_removal
:allowtitles:
```
...
* - {py:obj}`vectorized_worst_removal <src.models.policies.operators.destroy.worst_removal.vectorized_worst_removal>`
