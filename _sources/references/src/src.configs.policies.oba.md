...
:canonical: src.configs.policies.oba.OBAConfig.must_go
:type: typing.Optional[typing.List[typing.Any]]
:value: >
   'field(...)'

```{autodoc2-docstring} src.configs.policies.oba.OBAConfig.must_go
```

````

````{py:attribute} post_processing
:canonical: src.configs.policies.oba.OBAConfig.post_processing
:type: typing.Optional[typing.List[typing.Any]]
:value: >
   'field(...)'

```{autodoc2-docstring} src.configs.policies.oba.OBAConfig.post_processing
```
