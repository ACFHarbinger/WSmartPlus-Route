...
```{autodoc2-docstring} src.policies.route_construction.meta_heuristics.genetic_algorithm.policy_ga.GAPolicy._config_class
```
...
```{autodoc2-docstring} src.policies.route_construction.meta_heuristics.genetic_algorithm.policy_ga.GAPolicy._get_config_key
```
