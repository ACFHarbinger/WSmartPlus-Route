# {py:mod}`src.policies.helpers.reinforcement_learning.agents.contextual.base`

```{py:module} src.policies.helpers.reinforcement_learning.agents.contextual.base
```

```{autodoc2-docstring} src.policies.helpers.reinforcement_learning.agents.contextual.base
:allowtitles:
```
...
* - {py:obj}`ContextualBanditAgent <src.policies.helpers.reinforcement_learning.agents.contextual.base.ContextualBanditAgent>`
...
```{autodoc2-docstring} src.policies.helpers.reinforcement_learning.agents.contextual.base.ContextualBanditAgent.__init__
```

````{py:method} decay_epsilon()
:canonical: src.policies.helpers.reinforcement_learning.agents.contextual.base.ContextualBanditAgent.decay_epsilon

```{autodoc2-docstring} src.policies.helpers.reinforcement_learning.agents.contextual.base.ContextualBanditAgent.decay_epsilon
```
...
:canonical: src.policies.helpers.reinforcement_learning.agents.contextual.base.ContextualBanditAgent.get_weights

```{autodoc2-docstring} src.policies.helpers.reinforcement_learning.agents.contextual.base.ContextualBanditAgent.get_weights
```
