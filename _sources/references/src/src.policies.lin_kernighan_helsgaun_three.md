# {py:mod}`src.policies.lin_kernighan_helsgaun_three`

```{py:module} src.policies.lin_kernighan_helsgaun_three
```

```{autodoc2-docstring} src.policies.lin_kernighan_helsgaun_three
:allowtitles:
```
...
* - {py:obj}`__all__ <src.policies.lin_kernighan_helsgaun_three.__all__>`
  - ```{autodoc2-docstring} src.policies.lin_kernighan_helsgaun_three.__all__
    :summary:
    ```
````
...
````{py:data} __all__
:canonical: src.policies.lin_kernighan_helsgaun_three.__all__
:value: >
   ['solve_lkh3']
