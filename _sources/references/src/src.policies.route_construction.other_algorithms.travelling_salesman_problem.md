# {py:mod}`src.policies.route_construction.other_algorithms.travelling_salesman_problem`

```{py:module} src.policies.route_construction.other_algorithms.travelling_salesman_problem
```

```{autodoc2-docstring} src.policies.route_construction.other_algorithms.travelling_salesman_problem
:allowtitles:
```
