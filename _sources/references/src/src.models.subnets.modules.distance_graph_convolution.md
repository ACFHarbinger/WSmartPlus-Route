# {py:mod}`src.models.subnets.modules.distance_graph_convolution`

```{py:module} src.models.subnets.modules.distance_graph_convolution
```

```{autodoc2-docstring} src.models.subnets.modules.distance_graph_convolution
:allowtitles:
```
...
* - {py:obj}`DistanceAwareGraphConvolution <src.models.subnets.modules.distance_graph_convolution.DistanceAwareGraphConvolution>`
  - ```{autodoc2-docstring} src.models.subnets.modules.distance_graph_convolution.DistanceAwareGraphConvolution
    :summary:
    ```
````
...
:canonical: src.models.subnets.modules.distance_graph_convolution.DistanceAwareGraphConvolution
