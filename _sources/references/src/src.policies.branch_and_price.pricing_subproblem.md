...
:canonical: src.policies.branch_and_price.pricing_subproblem.PricingSubproblem.IS_EXACT
:value: >
   False

```{autodoc2-docstring} src.policies.branch_and_price.pricing_subproblem.PricingSubproblem.IS_EXACT
```
