# {py:mod}`src.policies.look_ahead_aux`

```{py:module} src.policies.look_ahead_aux
```

```{autodoc2-docstring} src.policies.look_ahead_aux
:allowtitles:
```
...
src.policies.look_ahead_aux.routes
```
