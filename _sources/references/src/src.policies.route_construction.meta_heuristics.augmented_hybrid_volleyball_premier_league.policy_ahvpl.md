...
```{autodoc2-docstring} src.policies.route_construction.meta_heuristics.augmented_hybrid_volleyball_premier_league.policy_ahvpl.AHVPLPolicy._config_class
```
...
```{autodoc2-docstring} src.policies.route_construction.meta_heuristics.augmented_hybrid_volleyball_premier_league.policy_ahvpl.AHVPLPolicy._get_config_key
```
