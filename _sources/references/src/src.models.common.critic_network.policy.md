# {py:mod}`src.models.common.critic_network.policy`

```{py:module} src.models.common.critic_network.policy
```

```{autodoc2-docstring} src.models.common.critic_network.policy
:allowtitles:
```
...
* - {py:obj}`CriticNetwork <src.models.common.critic_network.policy.CriticNetwork>`
  - ```{autodoc2-docstring} src.models.common.critic_network.policy.CriticNetwork
    :summary:
    ```
````
...
* - {py:obj}`create_critic_from_actor <src.models.common.critic_network.policy.create_critic_from_actor>`
...
```{autodoc2-docstring} src.models.common.critic_network.policy.CriticNetwork.__init__
```

````{py:method} forward(td: tensordict.TensorDict) -> torch.Tensor
:canonical: src.models.common.critic_network.policy.CriticNetwork.forward

```{autodoc2-docstring} src.models.common.critic_network.policy.CriticNetwork.forward
```
