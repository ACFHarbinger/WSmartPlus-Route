...
`````{py:class} NonAutoregressivePolicy(encoder: typing.Optional[src.models.common.non_autoregressive.encoder.NonAutoregressiveEncoder] = None, decoder: typing.Optional[src.models.common.non_autoregressive.decoder.NonAutoregressiveDecoder] = None, env_name: typing.Optional[str] = None, embed_dim: int = 128, **kwargs)
