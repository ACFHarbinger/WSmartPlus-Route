...
```{autodoc2-docstring} src.policies.route_construction.meta_heuristics.tabu_search.policy_ts.TSPolicy._config_class
```
...
```{autodoc2-docstring} src.policies.route_construction.meta_heuristics.tabu_search.policy_ts.TSPolicy._get_config_key
```
