...
```{autodoc2-docstring} src.policies.route_construction.meta_heuristics.evolution_strategy_mu_kappa_lambda.policy_es_mkl.MuKappaLambdaESPolicy._config_class
```
