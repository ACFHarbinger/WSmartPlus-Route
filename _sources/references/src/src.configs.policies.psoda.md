...
:canonical: src.configs.policies.psoda.DistancePSOConfig.profit_aware_operators
:type: bool
:value: >
   False

```{autodoc2-docstring} src.configs.policies.psoda.DistancePSOConfig.profit_aware_operators
```
...
:canonical: src.configs.policies.psoda.DistancePSOConfig.mandatory_selection
:type: typing.Optional[typing.List[src.configs.policies.other.mandatory_selection.MandatorySelectionConfig]]
:value: >
   None

```{autodoc2-docstring} src.configs.policies.psoda.DistancePSOConfig.mandatory_selection
```

````

````{py:attribute} route_improvement
:canonical: src.configs.policies.psoda.DistancePSOConfig.route_improvement
:type: typing.Optional[typing.List[src.configs.policies.other.route_improvement.RouteImprovingConfig]]
:value: >
   None

```{autodoc2-docstring} src.configs.policies.psoda.DistancePSOConfig.route_improvement
```
