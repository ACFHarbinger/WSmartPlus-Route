...
```{autodoc2-docstring} src.policies.acceptance_criteria.binary_tournament_acceptance.BinaryTournamentAcceptance.setup
```
...
```{autodoc2-docstring} src.policies.acceptance_criteria.binary_tournament_acceptance.BinaryTournamentAcceptance.accept
```
...
```{autodoc2-docstring} src.policies.acceptance_criteria.binary_tournament_acceptance.BinaryTournamentAcceptance.step
```
...
```{autodoc2-docstring} src.policies.acceptance_criteria.binary_tournament_acceptance.BinaryTournamentAcceptance.get_state
```
