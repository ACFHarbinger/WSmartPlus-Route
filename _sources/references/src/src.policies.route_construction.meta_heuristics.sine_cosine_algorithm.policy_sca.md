...
```{autodoc2-docstring} src.policies.route_construction.meta_heuristics.sine_cosine_algorithm.policy_sca.SCAPolicy._config_class
```
...
```{autodoc2-docstring} src.policies.route_construction.meta_heuristics.sine_cosine_algorithm.policy_sca.SCAPolicy._get_config_key
```
