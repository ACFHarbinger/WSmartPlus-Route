# {py:mod}`src.models.core.temporal_attention_model.model`

```{py:module} src.models.core.temporal_attention_model.model
```

```{autodoc2-docstring} src.models.core.temporal_attention_model.model
:allowtitles:
```
...
* - {py:obj}`TemporalAttentionModel <src.models.core.temporal_attention_model.model.TemporalAttentionModel>`
  - ```{autodoc2-docstring} src.models.core.temporal_attention_model.model.TemporalAttentionModel
    :summary:
    ```
````
