# {py:mod}`src.models.core.mdam.model`

```{py:module} src.models.core.mdam.model
```

```{autodoc2-docstring} src.models.core.mdam.model
:allowtitles:
```
...
* - {py:obj}`MDAM <src.models.core.mdam.model.MDAM>`
  - ```{autodoc2-docstring} src.models.core.mdam.model.MDAM
    :summary:
    ```
````
...
* - {py:obj}`mdam_rollout <src.models.core.mdam.model.mdam_rollout>`
...
`````{py:class} MDAM(env: logic.src.envs.base.base.RL4COEnvBase, policy: typing.Optional[src.models.core.mdam.policy.MDAMPolicy] = None, baseline: str = 'rollout', policy_kwargs: typing.Optional[typing.Dict[str, typing.Any]] = None, baseline_kwargs: typing.Optional[typing.Dict[str, typing.Any]] = None, kl_weight: float = 0.01)
:canonical: src.models.core.mdam.model.MDAM
...
:canonical: src.models.core.mdam.model.MDAM.calculate_loss

```{autodoc2-docstring} src.models.core.mdam.model.MDAM.calculate_loss
```

````

````{py:method} patch_baseline_rollout(baseline: typing.Any) -> None
:canonical: src.models.core.mdam.model.MDAM.patch_baseline_rollout
:staticmethod:

```{autodoc2-docstring} src.models.core.mdam.model.MDAM.patch_baseline_rollout
```
