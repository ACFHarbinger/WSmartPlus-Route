# {py:mod}`src.models.subnets.modules.graph_convolution`

```{py:module} src.models.subnets.modules.graph_convolution
```

```{autodoc2-docstring} src.models.subnets.modules.graph_convolution
:allowtitles:
```
...
* - {py:obj}`GraphConvolution <src.models.subnets.modules.graph_convolution.GraphConvolution>`
  - ```{autodoc2-docstring} src.models.subnets.modules.graph_convolution.GraphConvolution
    :summary:
    ```
````
...
:canonical: src.models.subnets.modules.graph_convolution.GraphConvolution
