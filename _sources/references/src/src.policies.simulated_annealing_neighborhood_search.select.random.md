# {py:mod}`src.policies.simulated_annealing_neighborhood_search.select.random`

```{py:module} src.policies.simulated_annealing_neighborhood_search.select.random
```

```{autodoc2-docstring} src.policies.simulated_annealing_neighborhood_search.select.random
:allowtitles:
```
...
* - {py:obj}`remove_bin <src.policies.simulated_annealing_neighborhood_search.select.random.remove_bin>`
  - ```{autodoc2-docstring} src.policies.simulated_annealing_neighborhood_search.select.random.remove_bin
    :summary:
    ```
* - {py:obj}`add_bin <src.policies.simulated_annealing_neighborhood_search.select.random.add_bin>`
  - ```{autodoc2-docstring} src.policies.simulated_annealing_neighborhood_search.select.random.add_bin
    :summary:
    ```
* - {py:obj}`remove_n_bins_random <src.policies.simulated_annealing_neighborhood_search.select.random.remove_n_bins_random>`
  - ```{autodoc2-docstring} src.policies.simulated_annealing_neighborhood_search.select.random.remove_n_bins_random
    :summary:
    ```
* - {py:obj}`add_n_bins_random <src.policies.simulated_annealing_neighborhood_search.select.random.add_n_bins_random>`
  - ```{autodoc2-docstring} src.policies.simulated_annealing_neighborhood_search.select.random.add_n_bins_random
    :summary:
    ```
* - {py:obj}`add_route_random <src.policies.simulated_annealing_neighborhood_search.select.random.add_route_random>`
  - ```{autodoc2-docstring} src.policies.simulated_annealing_neighborhood_search.select.random.add_route_random
    :summary:
    ```
* - {py:obj}`add_route_with_removed_bins_random <src.policies.simulated_annealing_neighborhood_search.select.random.add_route_with_removed_bins_random>`
