...
:canonical: src.configs.rl.policies.hgs.HGSConfig.population_size
:type: int
:value: >
   50

```{autodoc2-docstring} src.configs.rl.policies.hgs.HGSConfig.population_size
```

````

````{py:attribute} elite_size
:canonical: src.configs.rl.policies.hgs.HGSConfig.elite_size
:type: int
:value: >
   10

```{autodoc2-docstring} src.configs.rl.policies.hgs.HGSConfig.elite_size
```
...
```{autodoc2-docstring} src.configs.rl.policies.hgs.HGSConfig.n_generations
```
