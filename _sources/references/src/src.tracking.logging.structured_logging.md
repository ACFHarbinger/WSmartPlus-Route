# {py:mod}`src.tracking.logging.structured_logging`

```{py:module} src.tracking.logging.structured_logging
```

```{autodoc2-docstring} src.tracking.logging.structured_logging
:allowtitles:
```
...
* - {py:obj}`get_structured_logger <src.tracking.logging.structured_logging.get_structured_logger>`
  - ```{autodoc2-docstring} src.tracking.logging.structured_logging.get_structured_logger
    :summary:
    ```
* - {py:obj}`log_test_metric <src.tracking.logging.structured_logging.log_test_metric>`
  - ```{autodoc2-docstring} src.tracking.logging.structured_logging.log_test_metric
    :summary:
    ```
* - {py:obj}`log_benchmark_metric <src.tracking.logging.structured_logging.log_benchmark_metric>`
...
:canonical: src.tracking.logging.structured_logging.get_structured_logger
