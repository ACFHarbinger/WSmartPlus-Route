# {py:mod}`src.policies.other.operators.destroy.worst`

```{py:module} src.policies.other.operators.destroy.worst
```

```{autodoc2-docstring} src.policies.other.operators.destroy.worst
:allowtitles:
```
...
* - {py:obj}`worst_removal <src.policies.other.operators.destroy.worst.worst_removal>`
  - ```{autodoc2-docstring} src.policies.other.operators.destroy.worst.worst_removal
    :summary:
    ```
* - {py:obj}`worst_profit_removal <src.policies.other.operators.destroy.worst.worst_profit_removal>`
