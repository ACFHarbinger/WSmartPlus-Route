# {py:mod}`src.policies.branch_cut_and_price.dispatcher`

```{py:module} src.policies.branch_cut_and_price.dispatcher
```

```{autodoc2-docstring} src.policies.branch_cut_and_price.dispatcher
:allowtitles:
```
...
* - {py:obj}`run_bcp <src.policies.branch_cut_and_price.dispatcher.run_bcp>`
