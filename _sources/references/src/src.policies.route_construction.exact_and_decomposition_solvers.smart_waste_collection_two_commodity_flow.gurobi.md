...
````{py:function} _run_gurobi_optimizer(bins: numpy.typing.NDArray[numpy.float64], distance_matrix: typing.List[typing.List[float]], env: typing.Optional[gurobipy.Env], values: typing.Dict[str, float], binsids: typing.List[int], mandatory: typing.List[int], number_vehicles: int = 1, time_limit: int = 60, seed: int = 42, dual_values: typing.Optional[typing.Dict[int, float]] = None)
