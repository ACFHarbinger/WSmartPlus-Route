...
`````{py:class} N2S(env: typing.Optional[logic.src.envs.base.RL4COEnvBase] = None, policy: typing.Optional[src.models.core.n2s.policy.N2SPolicy] = None, embed_dim: int = 128, num_heads: int = 8, k_neighbors: int = 20, **policy_kwargs)
