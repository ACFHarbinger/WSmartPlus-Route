# {py:mod}`src.policies.other.operators.perturbation`

```{py:module} src.policies.other.operators.perturbation
```

```{autodoc2-docstring} src.policies.other.operators.perturbation
:allowtitles:
```
...
* - {py:obj}`__all__ <src.policies.other.operators.perturbation.__all__>`
