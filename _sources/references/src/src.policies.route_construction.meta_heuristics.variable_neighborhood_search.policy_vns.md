...
```{autodoc2-docstring} src.policies.route_construction.meta_heuristics.variable_neighborhood_search.policy_vns.VNSPolicy._config_class
```
...
```{autodoc2-docstring} src.policies.route_construction.meta_heuristics.variable_neighborhood_search.policy_vns.VNSPolicy._get_config_key
```
