...
`````{py:class} MDAMDecoder(embed_dim: int = 128, num_heads: int = 8, num_paths: int = 5, env_name: str = 'vrpp', mask_inner: bool = True, mask_logits: bool = True, eg_step_gap: int = 200, tanh_clipping: float = 10.0, train_decode_type: str = 'sampling', val_decode_type: str = 'greedy', test_decode_type: str = 'greedy')
...
````{py:method} forward(td: tensordict.TensorDict, embeddings: typing.Union[torch.Tensor, typing.Tuple[torch.Tensor, ...]], env: logic.src.envs.base.RL4COEnvBase, decode_type: str = 'greedy', **kwargs) -> typing.Tuple[torch.Tensor, torch.Tensor, torch.Tensor, torch.Tensor]
...
````{py:method} _decode_path(td: tensordict.TensorDict, h: torch.Tensor, env: logic.src.envs.base.RL4COEnvBase, attn: torch.Tensor, V: torch.Tensor, h_old: torch.Tensor, encoder: typing.Any, path_idx: int, decode_type: str) -> typing.Tuple[torch.Tensor, torch.Tensor, torch.Tensor]
