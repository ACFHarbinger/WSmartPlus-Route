# {py:mod}`src.pipeline.rl.common.trainer`

```{py:module} src.pipeline.rl.common.trainer
```

```{autodoc2-docstring} src.pipeline.rl.common.trainer
:allowtitles:
```
...
* - {py:obj}`WSTrainer <src.pipeline.rl.common.trainer.WSTrainer>`
  - ```{autodoc2-docstring} src.pipeline.rl.common.trainer.WSTrainer
    :summary:
    ```
````
...
:canonical: src.pipeline.rl.common.trainer.WSTrainer._create_default_logger

```{autodoc2-docstring} src.pipeline.rl.common.trainer.WSTrainer._create_default_logger
```
