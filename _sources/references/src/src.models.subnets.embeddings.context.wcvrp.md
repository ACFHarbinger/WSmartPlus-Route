...
:canonical: src.models.subnets.embeddings.context.wcvrp.WCVRPContextEmbedder._step_context

```{autodoc2-docstring} src.models.subnets.embeddings.context.wcvrp.WCVRPContextEmbedder._step_context
```
...
```{autodoc2-docstring} src.models.subnets.embeddings.context.wcvrp.WCVRPContextEmbedder.step_context_dim
```
