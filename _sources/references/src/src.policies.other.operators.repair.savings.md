...
````{py:function} savings_insertion(routes: typing.List[typing.List[int]], removed_nodes: typing.List[int], dist_matrix: numpy.ndarray, wastes: typing.Dict[int, float], capacity: float, depot: int = 0) -> typing.List[typing.List[int]]
