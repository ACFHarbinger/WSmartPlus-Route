# {py:mod}`src.policies.other.operators.crossover.ordered`

```{py:module} src.policies.other.operators.crossover.ordered
```

```{autodoc2-docstring} src.policies.other.operators.crossover.ordered
:allowtitles:
```
...
* - {py:obj}`ordered_crossover <src.policies.other.operators.crossover.ordered.ordered_crossover>`
