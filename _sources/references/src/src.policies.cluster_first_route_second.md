# {py:mod}`src.policies.cluster_first_route_second`

```{py:module} src.policies.cluster_first_route_second
```

```{autodoc2-docstring} src.policies.cluster_first_route_second
:allowtitles:
```
...
* - {py:obj}`__all__ <src.policies.cluster_first_route_second.__all__>`
