...
```{autodoc2-docstring} src.policies.acceptance_criteria.skewed_variable_neighborhood_search.SkewedVNSAcceptance.setup
```
...
```{autodoc2-docstring} src.policies.acceptance_criteria.skewed_variable_neighborhood_search.SkewedVNSAcceptance.accept
```
...
```{autodoc2-docstring} src.policies.acceptance_criteria.skewed_variable_neighborhood_search.SkewedVNSAcceptance.step
```
...
```{autodoc2-docstring} src.policies.acceptance_criteria.skewed_variable_neighborhood_search.SkewedVNSAcceptance.get_state
```
