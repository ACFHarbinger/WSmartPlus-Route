# {py:mod}`src.models.core.deepaco.model`

```{py:module} src.models.core.deepaco.model
```

```{autodoc2-docstring} src.models.core.deepaco.model
:allowtitles:
```
...
* - {py:obj}`DeepACO <src.models.core.deepaco.model.DeepACO>`
  - ```{autodoc2-docstring} src.models.core.deepaco.model.DeepACO
    :summary:
    ```
````
