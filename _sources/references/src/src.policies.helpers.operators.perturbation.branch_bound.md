# {py:mod}`src.policies.helpers.operators.perturbation.branch_bound`

```{py:module} src.policies.helpers.operators.perturbation.branch_bound
```

```{autodoc2-docstring} src.policies.helpers.operators.perturbation.branch_bound
:allowtitles:
```
...
* - {py:obj}`bb_perturbation <src.policies.helpers.operators.perturbation.branch_bound.bb_perturbation>`
  - ```{autodoc2-docstring} src.policies.helpers.operators.perturbation.branch_bound.bb_perturbation
    :summary:
    ```
* - {py:obj}`bb_profit_perturbation <src.policies.helpers.operators.perturbation.branch_bound.bb_profit_perturbation>`
  - ```{autodoc2-docstring} src.policies.helpers.operators.perturbation.branch_bound.bb_profit_perturbation
    :summary:
    ```
````
...
:canonical: src.policies.helpers.operators.perturbation.branch_bound.bb_perturbation
...
:canonical: src.policies.helpers.operators.perturbation.branch_bound.bb_profit_perturbation
