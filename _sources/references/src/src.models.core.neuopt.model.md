...
`````{py:class} NeuOpt(env: typing.Optional[logic.src.envs.base.base.RL4COEnvBase] = None, policy: typing.Optional[src.models.core.neuopt.policy.NeuOptPolicy] = None, embed_dim: int = 128, num_heads: int = 8, num_layers: int = 3, **policy_kwargs)
...
````{py:method} forward(td: typing.Any, env: typing.Optional[logic.src.envs.base.base.RL4COEnvBase] = None, strategy: str = 'greedy', **kwargs)
