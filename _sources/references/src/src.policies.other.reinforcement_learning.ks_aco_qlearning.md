...
`````{py:class} KSparseACOQLSolver(dist_matrix: numpy.ndarray, wastes: typing.Dict[int, float], capacity: float, R: float, C: float, params: logic.src.policies.ant_colony_optimization_k_sparse.params.KSACOParams, rl_params: typing.Any, mandatory_nodes: typing.Optional[typing.List[int]] = None)
