...
````{py:method} _generate_gaussian_mixture_array(num_loc: int, rng: numpy.random.Generator) -> numpy.ndarray
...
````{py:method} _generate_gaussian_array(batch_size: int, num_loc: int, rng: numpy.random.Generator) -> numpy.ndarray
