...
:canonical: src.data.distributions.spatial_gaussian_mixture.Gaussian_Mixture.sample_tensor

```{autodoc2-docstring} src.data.distributions.spatial_gaussian_mixture.Gaussian_Mixture.sample_tensor
```
