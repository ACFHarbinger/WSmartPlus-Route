...
```{autodoc2-docstring} src.policies.acceptance_criteria.non_linear_great_deluge.NonLinearGreatDeluge.setup
```
...
```{autodoc2-docstring} src.policies.acceptance_criteria.non_linear_great_deluge.NonLinearGreatDeluge.accept
```
...
```{autodoc2-docstring} src.policies.acceptance_criteria.non_linear_great_deluge.NonLinearGreatDeluge.step
```
...
```{autodoc2-docstring} src.policies.acceptance_criteria.non_linear_great_deluge.NonLinearGreatDeluge.get_state
```
