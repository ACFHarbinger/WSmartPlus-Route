# {py:mod}`src.policies.branch_and_cut.heuristics`

```{py:module} src.policies.branch_and_cut.heuristics
```

```{autodoc2-docstring} src.policies.branch_and_cut.heuristics
:allowtitles:
```
...
* - {py:obj}`construct_initial_solution <src.policies.branch_and_cut.heuristics.construct_initial_solution>`
  - ```{autodoc2-docstring} src.policies.branch_and_cut.heuristics.construct_initial_solution
    :summary:
    ```
* - {py:obj}`construct_nn_solution <src.policies.branch_and_cut.heuristics.construct_nn_solution>`
  - ```{autodoc2-docstring} src.policies.branch_and_cut.heuristics.construct_nn_solution
    :summary:
    ```
* - {py:obj}`farthest_insertion <src.policies.branch_and_cut.heuristics.farthest_insertion>`
  - ```{autodoc2-docstring} src.policies.branch_and_cut.heuristics.farthest_insertion
    :summary:
    ```
* - {py:obj}`_routes_to_tour <src.policies.branch_and_cut.heuristics._routes_to_tour>`
  - ```{autodoc2-docstring} src.policies.branch_and_cut.heuristics._routes_to_tour
    :summary:
    ```
* - {py:obj}`_apply_2opt_to_tour <src.policies.branch_and_cut.heuristics._apply_2opt_to_tour>`
...
:canonical: src.policies.branch_and_cut.heuristics._routes_to_tour
