...
* - {py:obj}`_dfs_iterative <src.policies.other.operators.crossover.generalized_partition._dfs_iterative>`
  - ```{autodoc2-docstring} src.policies.other.operators.crossover.generalized_partition._dfs_iterative
    :summary:
    ```
...
* - {py:obj}`_get_physical_edges <src.policies.other.operators.crossover.generalized_partition._get_physical_edges>`
  - ```{autodoc2-docstring} src.policies.other.operators.crossover.generalized_partition._get_physical_edges
    :summary:
    ```
* - {py:obj}`_get_components_from_uncommon_edges <src.policies.other.operators.crossover.generalized_partition._get_components_from_uncommon_edges>`
  - ```{autodoc2-docstring} src.policies.other.operators.crossover.generalized_partition._get_components_from_uncommon_edges
    :summary:
    ```
* - {py:obj}`_inherit_components <src.policies.other.operators.crossover.generalized_partition._inherit_components>`
  - ```{autodoc2-docstring} src.policies.other.operators.crossover.generalized_partition._inherit_components
    :summary:
    ```
* - {py:obj}`_greedy_pack_pool <src.policies.other.operators.crossover.generalized_partition._greedy_pack_pool>`
  - ```{autodoc2-docstring} src.policies.other.operators.crossover.generalized_partition._greedy_pack_pool
    :summary:
    ```
* - {py:obj}`_enforce_mandatory_nodes <src.policies.other.operators.crossover.generalized_partition._enforce_mandatory_nodes>`
  - ```{autodoc2-docstring} src.policies.other.operators.crossover.generalized_partition._enforce_mandatory_nodes
    :summary:
    ```
...
:canonical: src.policies.other.operators.crossover.generalized_partition._dfs_iterative
...
````{py:function} generalized_partition_crossover(p1: logic.src.policies.hybrid_genetic_search.individual.Individual, p2: logic.src.policies.hybrid_genetic_search.individual.Individual, rng: typing.Optional[random.Random] = None, mandatory_nodes: typing.Optional[typing.List[int]] = None, wastes: typing.Optional[typing.Dict[int, float]] = None, capacity: float = float('inf')) -> logic.src.policies.hybrid_genetic_search.individual.Individual
...
:canonical: src.policies.other.operators.crossover.generalized_partition._get_components_from_uncommon_edges

```{autodoc2-docstring} src.policies.other.operators.crossover.generalized_partition._get_components_from_uncommon_edges
```
````

````{py:function} _inherit_components(components: typing.List[typing.List[int]], p1: logic.src.policies.hybrid_genetic_search.individual.Individual, p2: logic.src.policies.hybrid_genetic_search.individual.Individual, wastes: typing.Dict[int, float], capacity: float, rng: random.Random) -> typing.Tuple[typing.List[typing.List[int]], typing.Set[int]]
:canonical: src.policies.other.operators.crossover.generalized_partition._inherit_components
...
:canonical: src.policies.other.operators.crossover.generalized_partition._greedy_pack_pool
...
:canonical: src.policies.other.operators.crossover.generalized_partition._enforce_mandatory_nodes

```{autodoc2-docstring} src.policies.other.operators.crossover.generalized_partition._enforce_mandatory_nodes
```
````

````{py:function} route_profit_gpx_crossover(p1: logic.src.policies.hybrid_genetic_search.individual.Individual, p2: logic.src.policies.hybrid_genetic_search.individual.Individual, dist_matrix: typing.Optional[numpy.ndarray], wastes: typing.Dict[int, float], capacity: float, R: float = 1.0, C: float = 1.0, rng: typing.Optional[random.Random] = None, mandatory_nodes: typing.Optional[typing.List[int]] = None) -> logic.src.policies.hybrid_genetic_search.individual.Individual
