# {py:mod}`src.policies.local_branching.solver`

```{py:module} src.policies.local_branching.solver
```

```{autodoc2-docstring} src.policies.local_branching.solver
:allowtitles:
```
...
* - {py:obj}`_add_local_branching_constraint <src.policies.local_branching.solver._add_local_branching_constraint>`
  - ```{autodoc2-docstring} src.policies.local_branching.solver._add_local_branching_constraint
    :summary:
    ```
* - {py:obj}`run_local_branching_gurobi <src.policies.local_branching.solver.run_local_branching_gurobi>`
  - ```{autodoc2-docstring} src.policies.local_branching.solver.run_local_branching_gurobi
    :summary:
    ```
````
...
:canonical: src.policies.local_branching.solver._add_local_branching_constraint
...
:canonical: src.policies.local_branching.solver.run_local_branching_gurobi
