# {py:mod}`src.policies.helpers.operators.destroy.shaw`

```{py:module} src.policies.helpers.operators.destroy.shaw
```

```{autodoc2-docstring} src.policies.helpers.operators.destroy.shaw
:allowtitles:
```
...
* - {py:obj}`shaw_removal <src.policies.helpers.operators.destroy.shaw.shaw_removal>`
  - ```{autodoc2-docstring} src.policies.helpers.operators.destroy.shaw.shaw_removal
    :summary:
    ```
* - {py:obj}`shaw_profit_removal <src.policies.helpers.operators.destroy.shaw.shaw_profit_removal>`
  - ```{autodoc2-docstring} src.policies.helpers.operators.destroy.shaw.shaw_profit_removal
    :summary:
    ```
````
...
:canonical: src.policies.helpers.operators.destroy.shaw.shaw_removal
...
:canonical: src.policies.helpers.operators.destroy.shaw.shaw_profit_removal
