# {py:mod}`src.tracking.logging.modules.metrics`

```{py:module} src.tracking.logging.modules.metrics
```

```{autodoc2-docstring} src.tracking.logging.modules.metrics
:allowtitles:
```
...
* - {py:obj}`log_values <src.tracking.logging.modules.metrics.log_values>`
  - ```{autodoc2-docstring} src.tracking.logging.modules.metrics.log_values
    :summary:
    ```
* - {py:obj}`log_epoch <src.tracking.logging.modules.metrics.log_epoch>`
  - ```{autodoc2-docstring} src.tracking.logging.modules.metrics.log_epoch
    :summary:
    ```
* - {py:obj}`get_loss_stats <src.tracking.logging.modules.metrics.get_loss_stats>`
  - ```{autodoc2-docstring} src.tracking.logging.modules.metrics.get_loss_stats
    :summary:
    ```
````
...
:canonical: src.tracking.logging.modules.metrics.get_loss_stats
