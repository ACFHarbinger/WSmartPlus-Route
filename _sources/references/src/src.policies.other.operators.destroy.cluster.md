# {py:mod}`src.policies.other.operators.destroy.cluster`

```{py:module} src.policies.other.operators.destroy.cluster
```

```{autodoc2-docstring} src.policies.other.operators.destroy.cluster
:allowtitles:
```
...
* - {py:obj}`cluster_removal <src.policies.other.operators.destroy.cluster.cluster_removal>`
