# {py:mod}`src.policies.branch_and_price_and_cut`

```{py:module} src.policies.branch_and_price_and_cut
```

```{autodoc2-docstring} src.policies.branch_and_price_and_cut
:allowtitles:
```
...
* - {py:obj}`__all__ <src.policies.branch_and_price_and_cut.__all__>`
