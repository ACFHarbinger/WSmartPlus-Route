# {py:mod}`src.models.subnets.decoders.ptr.pointer_attention`

```{py:module} src.models.subnets.decoders.ptr.pointer_attention
```

```{autodoc2-docstring} src.models.subnets.decoders.ptr.pointer_attention
:allowtitles:
```
...
* - {py:obj}`PointerAttention <src.models.subnets.decoders.ptr.pointer_attention.PointerAttention>`
  - ```{autodoc2-docstring} src.models.subnets.decoders.ptr.pointer_attention.PointerAttention
    :summary:
    ```
````
