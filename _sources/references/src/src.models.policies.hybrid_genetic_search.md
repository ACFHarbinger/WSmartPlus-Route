...
`````{py:class} VectorizedHGS(dist_matrix: torch.Tensor, wastes: torch.Tensor, vehicle_capacity: typing.Any, max_iterations: int = 50, time_limit: float = 1.0, device: str = 'cuda', seed: int = 42, generator: typing.Optional[torch.Generator] = None, rng: typing.Optional[random.Random] = None)
