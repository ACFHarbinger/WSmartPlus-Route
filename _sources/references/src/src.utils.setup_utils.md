# {py:mod}`src.utils.setup_utils`

```{py:module} src.utils.setup_utils
```

```{autodoc2-docstring} src.utils.setup_utils
:allowtitles:
```
...
* - {py:obj}`setup_cost_weights <src.utils.setup_utils.setup_cost_weights>`
  - ```{autodoc2-docstring} src.utils.setup_utils.setup_cost_weights
    :summary:
    ```
* - {py:obj}`setup_hrl_manager <src.utils.setup_utils.setup_hrl_manager>`
  - ```{autodoc2-docstring} src.utils.setup_utils.setup_hrl_manager
    :summary:
    ```
* - {py:obj}`setup_model <src.utils.setup_utils.setup_model>`
  - ```{autodoc2-docstring} src.utils.setup_utils.setup_model
    :summary:
    ```
* - {py:obj}`setup_env <src.utils.setup_utils.setup_env>`
  - ```{autodoc2-docstring} src.utils.setup_utils.setup_env
    :summary:
    ```
* - {py:obj}`setup_model_and_baseline <src.utils.setup_utils.setup_model_and_baseline>`
  - ```{autodoc2-docstring} src.utils.setup_utils.setup_model_and_baseline
    :summary:
    ```
* - {py:obj}`setup_optimizer_and_lr_scheduler <src.utils.setup_utils.setup_optimizer_and_lr_scheduler>`
  - ```{autodoc2-docstring} src.utils.setup_utils.setup_optimizer_and_lr_scheduler
    :summary:
    ```
````
...
:canonical: src.utils.setup_utils.setup_cost_weights
...
:canonical: src.utils.setup_utils.setup_hrl_manager
...
:canonical: src.utils.setup_utils.setup_model
...
:canonical: src.utils.setup_utils.setup_env
...
:canonical: src.utils.setup_utils.setup_model_and_baseline
...
:canonical: src.utils.setup_utils.setup_optimizer_and_lr_scheduler
