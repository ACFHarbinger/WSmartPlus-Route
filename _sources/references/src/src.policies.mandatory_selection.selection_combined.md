# {py:mod}`src.policies.mandatory_selection.selection_combined`

```{py:module} src.policies.mandatory_selection.selection_combined
```

```{autodoc2-docstring} src.policies.mandatory_selection.selection_combined
:allowtitles:
```
...
* - {py:obj}`CombinedSelection <src.policies.mandatory_selection.selection_combined.CombinedSelection>`
