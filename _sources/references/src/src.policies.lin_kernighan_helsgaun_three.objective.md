...
* - {py:obj}`penalty_delta <src.policies.lin_kernighan_helsgaun_three.objective.penalty_delta>`
  - ```{autodoc2-docstring} src.policies.lin_kernighan_helsgaun_three.objective.penalty_delta
    :summary:
    ```
* - {py:obj}`compute_min_1_tree <src.policies.lin_kernighan_helsgaun_three.objective.compute_min_1_tree>`
  - ```{autodoc2-docstring} src.policies.lin_kernighan_helsgaun_three.objective.compute_min_1_tree
    :summary:
    ```
* - {py:obj}`solve_subgradient <src.policies.lin_kernighan_helsgaun_three.objective.solve_subgradient>`
  - ```{autodoc2-docstring} src.policies.lin_kernighan_helsgaun_three.objective.solve_subgradient
    :summary:
    ```
* - {py:obj}`_compute_all_pairs_max_edge <src.policies.lin_kernighan_helsgaun_three.objective._compute_all_pairs_max_edge>`
  - ```{autodoc2-docstring} src.policies.lin_kernighan_helsgaun_three.objective._compute_all_pairs_max_edge
    :summary:
    ```
* - {py:obj}`compute_alpha_measures <src.policies.lin_kernighan_helsgaun_three.objective.compute_alpha_measures>`
  - ```{autodoc2-docstring} src.policies.lin_kernighan_helsgaun_three.objective.compute_alpha_measures
    :summary:
    ```
* - {py:obj}`get_candidate_set <src.policies.lin_kernighan_helsgaun_three.objective.get_candidate_set>`
  - ```{autodoc2-docstring} src.policies.lin_kernighan_helsgaun_three.objective.get_candidate_set
    :summary:
    ```
````
...
:canonical: src.policies.lin_kernighan_helsgaun_three.objective.compute_min_1_tree
...
:canonical: src.policies.lin_kernighan_helsgaun_three.objective.solve_subgradient
...
:canonical: src.policies.lin_kernighan_helsgaun_three.objective._compute_all_pairs_max_edge
...
:canonical: src.policies.lin_kernighan_helsgaun_three.objective.compute_alpha_measures
...
:canonical: src.policies.lin_kernighan_helsgaun_three.objective.get_candidate_set
