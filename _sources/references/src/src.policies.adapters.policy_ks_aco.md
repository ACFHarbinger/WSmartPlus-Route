# {py:mod}`src.policies.adapters.policy_ks_aco`

```{py:module} src.policies.adapters.policy_ks_aco
```

```{autodoc2-docstring} src.policies.adapters.policy_ks_aco
:allowtitles:
```
...
* - {py:obj}`ACOPolicy <src.policies.adapters.policy_ks_aco.ACOPolicy>`
  - ```{autodoc2-docstring} src.policies.adapters.policy_ks_aco.ACOPolicy
    :summary:
    ```
````
...
```{autodoc2-docstring} src.policies.adapters.policy_ks_aco.ACOPolicy._get_config_key
```
...
:canonical: src.policies.adapters.policy_ks_aco.ACOPolicy._run_solver

```{autodoc2-docstring} src.policies.adapters.policy_ks_aco.ACOPolicy._run_solver
```
