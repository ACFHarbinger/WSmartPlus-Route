# {py:mod}`src.models.subnets.modules.normalized_activation_function`

```{py:module} src.models.subnets.modules.normalized_activation_function
```

```{autodoc2-docstring} src.models.subnets.modules.normalized_activation_function
:allowtitles:
```
...
* - {py:obj}`NormalizedActivationFunction <src.models.subnets.modules.normalized_activation_function.NormalizedActivationFunction>`
  - ```{autodoc2-docstring} src.models.subnets.modules.normalized_activation_function.NormalizedActivationFunction
    :summary:
    ```
````
...
:canonical: src.models.subnets.modules.normalized_activation_function.NormalizedActivationFunction
