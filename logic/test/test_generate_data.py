...
class TestVRPInstanceBuilder:
    ...
    def test_build_simple_random(self, builder, mocker):
        ...
        mocker.patch('logic.src.data.builders.generate_waste_prize', return_value=np.zeros((10, 20)))
    ...
    def test_build_with_focus_graph(self, builder, mocker):
        ...
        # Setup builder
        builder.set_dataset_size(10) \
               .set_problem_size(20) \
               .set_focus_graph('focus.json', 10)
...
class TestGenerateData:
    ...
    @pytest.mark.parametrize("problem, expected_distributions", [
        ('wcvrp', ['empty', 'const', 'unif', 'dist', 'emp', 'gamma1', 'gamma2', 'gamma3', 'gamma4']),
    ])
    @pytest.mark.unit
    def test_multiple_distribution_generation(self, gen_data_opts, problem, expected_distributions, mock_builder, mocker):
    ...
    def test_multiple_sizes_generation(self, gen_data_opts, mock_builder, mocker):
        ...
        gen_data_opts['focus_graphs'] = ['dummy1', 'dummy2'] # Strings to avoid TypeError in os.path.isfile
