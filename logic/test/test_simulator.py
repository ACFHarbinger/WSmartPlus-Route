...
class TestCheckpoints:
    ...
    def test_load_latest_state(self, basic_checkpoint, mocker):
        ...
        mocker.patch('logic.src.pipeline.simulator.checkpoints.os.listdir', return_value=saved_filenames)
        # --------------------------------------------------------
...
class TestLoader:
    ...
    def test_load_depot(self, mock_data_dir, mocker):
        ...
        mocker.patch(
            'logic.src.pipeline.simulator.loader.udef.MAP_DEPOTS',
            {'riomaior': 'RM'}
        )
...
class TestSimulation:
    ...
    def test_single_simulation_happy_path_am(
        ...
        #     In test setup: 
        #     mocker.patch('logic.src.pipeline.simulator.bins.load_area_and_waste_type_params', return_value=(4000, 0.16, 60.0, 1.0, 2.5))
