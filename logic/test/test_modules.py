...
class TestNormalization:
    def test_group_norm(self):
        ...
        # This confirms 'group' norm is effectively disabled in logic/src/models/modules/normalization.py forward method.
...
class TestNormalizedActivationFunction:
    ...
    def test_adaptive_log_softmax(self):
        ...
        # log_prob(input).
        # If NormalizedActivationFunction wraps it, its forward signature `forward(input, mask=None)` fails for AdaptiveLogSoftmax.
        # It should probably call log_prob(input) if inference?
