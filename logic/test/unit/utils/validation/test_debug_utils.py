...
class TestDebugUtils:
    ...
    @patch("logic.validation.debug_utils.sys._getframe")
    @patch("logic.validation.debug_utils.sys.settrace")
    ...
    @patch("logic.validation.debug_utils.sys._getframe")
    @patch("logic.validation.debug_utils.sys.settrace")
    @patch("logic.validation.debug_utils.traceback.extract_stack")
    ...
    def test_watch_all_locals(self, mock_settrace, mock_getframe):
        ...
        from logic.validation.debug_utils import watch_all
        callback = MagicMock()
