...
from logic.src.utils.expo.visualize_utils import (
    get_batch,
    imitation_loss_fn,
...
class TestVisualizeUtils(unittest.TestCase):
    ...
    @patch("logic.src.utils.expo.visualization.embeddings.plt")
    @patch("logic.src.utils.expo.visualization.embeddings.os.listdir")
    @patch("logic.src.utils.expo.visualization.embeddings.torch.load")
    ...
    @patch("logic.src.utils.expo.visualization.embeddings.SummaryWriter")
    ...
    @patch("logic.src.utils.expo.visualization.heatmaps.plt")
    @patch("logic.src.utils.expo.visualization.heatmaps.sns")
...
class TestVisualizeEpochCoverage:
    ...
    @patch("logic.src.utils.expo.visualization.plot_weight_trajectories")
    @patch("logic.src.utils.expo.visualization.log_weight_distributions")
    @patch("logic.src.utils.expo.visualization.plot_attention_heatmaps")
    @patch("logic.src.utils.expo.visualization.plot_loss_landscape")
    @patch("logic.src.utils.expo.visualization.project_node_embeddings")
    @patch("logic.src.utils.expo.visualization.get_batch")
    def test_visualize_epoch_all_modes(self, mock_batch, mock_embed, mock_loss, mock_att, mock_dist, mock_traj):
        ...
        with patch("logic.src.utils.expo.visualization.plot_logit_lens") as mock_lens:
    ...
    @patch("logic.src.utils.expo.visualization.load_model_instance")
    @patch("logic.src.utils.expo.visualization.log_weight_distributions")
