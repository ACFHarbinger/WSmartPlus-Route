...
from logic.src.utils.expo.visualization.landscape import (
    imitation_loss_fn,
    rl_loss_fn,
    plot_loss_landscape
)
...
@patch("logic.src.utils.expo.visualization.landscape.get_batch")
@patch("logic.src.utils.expo.visualization.landscape.vectorized_two_opt")
@patch("logic.src.utils.expo.visualization.landscape.loss_landscapes.random_plane")
@patch("logic.src.utils.expo.visualization.landscape.plt")
...
def test_rl_loss_fn_exception_handling(mock_model, tmp_path, mocker):
    ...
    mocker.patch("logic.src.utils.expo.visualization.landscape.get_batch", return_value={"dist": torch.zeros((1, 5, 5))})
    mocker.patch("logic.src.utils.expo.visualization.landscape.vectorized_two_opt", return_value=torch.zeros((16, 51), dtype=torch.long))
