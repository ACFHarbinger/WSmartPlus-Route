...
from logic.src.utils.io import locking, dict_processing, file_processing, value_processing, statistics
...
class TestProcessing:
    ...
    @patch("logic.src.utils.io.file_processing.os")
    ...
    @patch("logic.src.utils.io.file_processing.os")
    @patch("logic.src.utils.io.file_processing.glob.glob")
    @patch("builtins.open", new_callable=mock_open, read_data='{"a": {"km": 10}}')
    @patch("json.dump")
    ...
    @patch("logic.src.utils.io.statistics.os.path.exists")
    @patch("logic.src.utils.io.statistics.os.path.isfile")
