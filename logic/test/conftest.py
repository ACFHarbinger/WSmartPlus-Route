...
from logic.src.models.attention_model import AttentionModel  # noqa: E402
from logic.src.models.gat_lstm_manager import GATLSTManager  # noqa: E402
from logic.src.models.model_factory import NeuralComponentFactory  # noqa: E402
from logic.src.models.subnets.attention_decoder import AttentionDecoder  # noqa: E402
from logic.src.models.temporal_am import TemporalAttentionModel  # noqa: E402
from logic.src.pipeline.reinforcement_learning.meta.contextual_bandits import (  # noqa: E402
    WeightContextualBandit,
)
from logic.src.pipeline.reinforcement_learning.meta.multi_objective import (  # noqa: E402
    MORLWeightOptimizer,
)
from logic.src.pipeline.reinforcement_learning.meta.temporal_difference_learning import (  # noqa: E402
    CostWeightManager,
)
from logic.src.pipeline.reinforcement_learning.meta.weight_optimizer import (  # noqa: E402
    RewardWeightOptimizer,
)
from logic.src.pipeline.simulator.bins import Bins  # noqa: E402
from logic.src.pipeline.simulator.context import SimulationDayContext  # noqa: E402
...
def base_test_args():
    ...
    return [
        "script.py",
        "test_sim",  # Changed from 'test' to 'test_sim' to match your parser
        "--policies",
        "policy1",
        "--days",
        "31",
...
def basic_checkpoint(mocker, tmp_path):
    ...
    mocker.patch("logic.src.pipeline.simulator.checkpoints.ROOT_DIR", new=str(mock_root))
...
def mock_sim_dependencies(mocker, tmp_path, mock_bins_instance):
    ...
    mock_process_data = mocker.patch(
        "logic.src.pipeline.simulator.states.process_data",
        return_value=(mock_proc_data.copy(), mock_proc_coords.copy()),
    )
    mocker.patch(
        "logic.src.pipeline.simulator.states.process_model_data",
    ...
    mock_setup_dist = mocker.patch(
        "logic.src.pipeline.simulator.states.setup_dist_path_tup",
    ...
    mock_run_day = mocker.patch(  # CAPTURE the mock object here
        "logic.src.pipeline.simulator.states.run_day", return_value=mock_return_ctx
    )
    ...
    mocker.patch(
        "logic.src.pipeline.simulator.states.SimulationCheckpoint",
    ...
    mocker.patch("logic.src.pipeline.simulator.states.checkpoint_manager", return_value=mock_cm)
...
def mock_run_day_deps(mocker):
    ...
    mock_send_output = mocker.patch("logic.src.pipeline.simulator.actions.send_daily_output_to_gui", autospec=True)
