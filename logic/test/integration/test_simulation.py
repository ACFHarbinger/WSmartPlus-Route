...
def test_run_day_execution():
    ...
    with patch("logic.src.pipeline.simulations.actions.FillAction") as MockFill, patch(
        "logic.src.pipeline.simulations.actions.PolicyExecutionAction"
    ) as MockPolicy, patch("logic.src.pipeline.simulations.actions.CollectAction") as MockCollect, patch(
        "logic.src.pipeline.simulations.actions.LogAction"
    ) as MockLog:
