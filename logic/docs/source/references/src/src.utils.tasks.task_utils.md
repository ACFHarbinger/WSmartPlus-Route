# {py:mod}`src.utils.tasks.task_utils`

```{py:module} src.utils.tasks.task_utils
```

```{autodoc2-docstring} src.utils.tasks.task_utils
:allowtitles:
```
...
* - {py:obj}`calculate_edges <src.utils.tasks.task_utils.calculate_edges>`
  - ```{autodoc2-docstring} src.utils.tasks.task_utils.calculate_edges
    :summary:
    ```
* - {py:obj}`make_instance_generic <src.utils.tasks.task_utils.make_instance_generic>`
