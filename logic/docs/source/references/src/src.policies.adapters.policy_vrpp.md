...
* - {py:obj}`run_vrpp_optimizer <src.policies.adapters.policy_vrpp.run_vrpp_optimizer>`
  - ```{autodoc2-docstring} src.policies.adapters.policy_vrpp.run_vrpp_optimizer
    :summary:
    ```
* - {py:obj}`_run_gurobi_optimizer <src.policies.adapters.policy_vrpp._run_gurobi_optimizer>`
  - ```{autodoc2-docstring} src.policies.adapters.policy_vrpp._run_gurobi_optimizer
    :summary:
    ```
* - {py:obj}`_run_hexaly_optimizer <src.policies.adapters.policy_vrpp._run_hexaly_optimizer>`
  - ```{autodoc2-docstring} src.policies.adapters.policy_vrpp._run_hexaly_optimizer
    :summary:
    ```
````
...
:canonical: src.policies.adapters.policy_vrpp.run_vrpp_optimizer
...
:canonical: src.policies.adapters.policy_vrpp._run_gurobi_optimizer
...
:canonical: src.policies.adapters.policy_vrpp._run_hexaly_optimizer
...
```{autodoc2-docstring} src.policies.adapters.policy_vrpp.VRPPPolicy._get_config_key
```
