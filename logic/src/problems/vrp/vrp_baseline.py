...
def get_lkh_executable(url="http://www.akira.ruc.dk/~keld/research/LKH-3/LKH-3.0.4.tgz"):
    ...
    try:
        ...
        raise Exception("directory to save LHK files does not exist and could not be created")
        ...
        if method == "lkh":
            ...
            if not os.path.isdir(target_dir):
                try:
                    ...
                    raise Exception("target directory not exist and could not be created")
