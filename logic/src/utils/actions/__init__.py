"""
Unified tensor actions/operations for combinatorial optimization.

This package provides commonly-used tensor actions/operations for CO problems.
...
Example:
    >>> from logic.src.utils.actions import get_distance
    >>> x = torch.tensor([0.0, 0.0])
    >>> y = torch.tensor([3.0, 4.0])
    >>> get_distance(x, y)
    tensor(5.)
    >>> from logic.src.utils.actions.distance import get_distance_matrix
    ...
    tensor([16.])
    >>> from logic.src.utils.actions.distance import get_open_tour_length
