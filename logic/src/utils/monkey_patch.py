...
def load_state_dict(self, state_dict):
    ...
    This patched version ensures that state tensors are correctly cast to the
    device of the parameters they correspond to, which is critical when loading
    checkpoints across different devices (e.g., CPU to GPU).
