...
class AttentionDecoder(nn.Module):
    ...
    def forward(self, input, embeddings, cost_weights=None, dist_matrix=None, mask=None, expert_pi=None):
        """
        Wrapper around _inner to match standard Module behavior.
        """
        # _inner returns (log_p, pi)
        return self._inner(input, None, embeddings, cost_weights, dist_matrix, profit_vars=None, mask=mask, expert_pi=expert_pi)
