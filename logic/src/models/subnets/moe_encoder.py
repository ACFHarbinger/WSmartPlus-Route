...
from ..modules import (
    MultiHeadAttention, Normalization
)
from ..modules.moe_feed_forward import MoEFeedForward
...
class MoEMultiHeadAttentionLayer(nn.Module):
    ...
    def __init__(self, n_heads, embed_dim, feed_forward_hidden, normalization, 
                ...
                connection_type='skip', expansion_rate=4, num_experts=4, k=2, noisy_gating=True):
        ...
        self.ff = get_connection_module(
            module=MoEFeedForward(embed_dim, feed_forward_hidden, activation, af_param,
...
class MoEGraphAttentionEncoder(nn.Module):
    ...
    def __init__(self, 
        ...
        self.layers = nn.ModuleList([
            MoEMultiHeadAttentionLayer(n_heads, embed_dim, feed_forward_hidden, normalization, 
