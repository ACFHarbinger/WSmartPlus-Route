...
Multi-strategy decoder using PolyNet attention for diverse solution construction.
"""
...
from logic.src.models.modules.polynet_attention import PolyNetAttention
...
class PolyNetDecoder(nn.Module):
    ...
    Uses PolyNetAttention to learn K diverse solution strategies from a single model.
    Supports both AttentionModel and MatNet encoder backends.
    ...
    def __init__(
        ...
        Args:
            ...
            poly_layer_dim: PolyNet hidden layer dimension.
            num_heads: Number of attention heads.
            env_name: Environment name for context embedding.
            mask_inner: Whether to mask inner attention.
            out_bias: Whether to use bias in pointer attention.
            linear_bias: Whether to use bias in linear projections.
