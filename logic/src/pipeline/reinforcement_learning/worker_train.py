...
def train_reinforce_over_time_rwa(
    model,
    optimizer,
    baseline,
    lr_scheduler,
...
def train_reinforce_over_time_cb(
    model,
    optimizer,
    baseline,
    lr_scheduler,
    ...
    """
    trainer = ContextualBanditTrainer(
        model,
        optimizer,
        baseline,
        lr_scheduler,
...
def train_reinforce_over_time_tdl(
    model,
    optimizer,
    baseline,
    lr_scheduler,
...
def train_reinforce_over_time_morl(
    model,
    optimizer,
    baseline,
    lr_scheduler,
...
def train_over_time_with_hypernetwork(
    model,
    optimizer,
    baseline,
    lr_scheduler,
...
def train_reinforce_over_time_hrl(
    model,
    optimizer,
    baseline,
    lr_scheduler,
...
def train_reinforce_over_time(
    ...
    if opts.get("rwa", False):
        return train_reinforce_over_time_rwa(
            model,
            optimizer,
            baseline,
            lr_scheduler,
        ...
        return train_reinforce_over_time_cb(
            model,
            optimizer,
            baseline,
            lr_scheduler,
        ...
        return train_reinforce_over_time_tdl(
            model,
            optimizer,
            baseline,
            lr_scheduler,
        ...
        return train_reinforce_over_time_morl(
            model,
            optimizer,
            baseline,
            lr_scheduler,
        ...
        return train_over_time_with_hypernetwork(
            model,
            optimizer,
            baseline,
            lr_scheduler,
        ...
        return train_reinforce_over_time_hrl(
            model,
            optimizer,
            baseline,
            lr_scheduler,
