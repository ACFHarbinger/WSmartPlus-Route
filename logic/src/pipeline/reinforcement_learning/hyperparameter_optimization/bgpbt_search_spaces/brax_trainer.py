...
from brax.envs.wrappers import torch
from hyperparameter_optimization.bgpbt_brax_train import ppo_torch as ppo


# Adapted from https://github.com/xingchenwan/bgpbt/blob/main/search_spaces/brax_utils.py
...
def get_brax_trainer(params: dict, load_path: str = None, mismatch_policy: str = 'ignore', alg_name='ppo'):
    ...
    env = torch.TorchWrapper(env, device=device)
    # Warm-start
    env.reset()
