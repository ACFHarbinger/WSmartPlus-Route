    ...
    def update_ppo(self, rollouts):
        ...
        for _ in range(self.ppo_epochs):
            ...
            for data in rollouts:
                ...
                # Calculate Advantage
                # For basic PPO without GAE-Lambda across time steps (since VRP is often 1-step MDP
                # or we treat partial tour construction differently), if these are complete tours:
