from .adaptive_memory_programming_hyper_heuristic import policy_amp as policy_amp_hh
...
from .genetic_programming_multi_period_hyper_heuristic import policy_gphh as policy_gp_mp_hh
...
from .population_hyper_heuristic import policy_phh as policy_phh
