...
Example:
    >>> from logic.src.policies.other.must_go.selection_savings import SavingsSelection
...
@MustGoSelectionRegistry.register("savings")
class SavingsSelection(IMustGoSelectionStrategy):
    """
    ...
    def select_bins(self, context: SelectionContext) -> List[int]:
        ...
        must_go_indices = candidate_indices[has_saving]
