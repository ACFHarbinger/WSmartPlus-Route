...
@MustGoSelectionRegistry.register("stochastic_regret")
class StochasticRegretSelection(IMustGoSelectionStrategy):
    """
    ...
    def select_bins(self, context: SelectionContext) -> List[int]:
        ...
        must_go_indices = np.nonzero(expected_overflow > context.threshold)[0]
