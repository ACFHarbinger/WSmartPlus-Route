...
Example:
    >>> from logic.src.policies.other.must_go.selection_set_cover import SetCoverSelection
...
@MustGoSelectionRegistry.register("set_cover")
class SetCoverSelection(IMustGoSelectionStrategy):
    """
