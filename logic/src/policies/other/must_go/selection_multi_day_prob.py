...
Example:
    >>> from logic.src.policies.other.must_go.selection_multi_day_prob import MultiDayOverflowSelection
...
@MustGoSelectionRegistry.register("multi_day_prob")
class MultiDayOverflowSelection(IMustGoSelectionStrategy):
    """
    ...
    def select_bins(self, context: SelectionContext) -> List[int]:
        ...
        must_go_indices = np.nonzero(prob_overflow >= context.threshold)[0]
