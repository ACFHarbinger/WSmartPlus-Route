...
Example:
    >>> from logic.src.policies.other.must_go.selection_deadline import DeadlineDrivenSelection
...
@MustGoSelectionRegistry.register("deadline")
class DeadlineDrivenSelection(IMustGoSelectionStrategy):
    """
    ...
    def select_bins(self, context: SelectionContext) -> List[int]:
        ...
        must_go_indices = np.nonzero(days_to_overflow <= horizon_days)[0]
