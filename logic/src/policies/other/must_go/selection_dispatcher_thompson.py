...
Sampling to select the best "must-go" strategy among a set of candidates
...
Example:
    >>> from logic.src.policies.other.must_go.selection_dispatcher_thompson import ThompsonDispatcher
...
@MustGoSelectionRegistry.register("dispatcher_thompson")
class ThompsonDispatcher(IMustGoSelectionStrategy):
    """
    ...
    def select_bins(self, context: SelectionContext) -> List[int]:
        ...
        # Dispatch
        strategy = MustGoSelectionFactory.create_strategy(winner_name)
