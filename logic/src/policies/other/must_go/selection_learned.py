...
Example:
    >>> from logic.src.policies.other.must_go.selection_learned import LearnedSelection
...
@MustGoSelectionRegistry.register("learned")
class LearnedSelection(IMustGoSelectionStrategy):
    """
    ...
    def select_bins(self, context: SelectionContext) -> List[int]:
        ...
        must_go_indices = np.nonzero(probs >= threshold)[0]
