...
Exact 0/1 multiple-knapsack formulation of must-go bin selection solved
...
Example:
    >>> from logic.src.policies.other.must_go.selection_mip_knapsack \\
...
@MustGoSelectionRegistry.register("mip_knapsack")
class MIPKnapsackSelection(IMustGoSelectionStrategy):
