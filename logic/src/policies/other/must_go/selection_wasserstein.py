...
Example:
    >>> from logic.src.policies.other.must_go.selection_wasserstein import WassersteinRobustSelection
...
@MustGoSelectionRegistry.register("wasserstein_robust")
class WassersteinRobustSelection(IMustGoSelectionStrategy):
    """
    ...
    def select_bins(self, context: SelectionContext) -> List[int]:
        ...
        must_go_indices = np.nonzero(robust_expectation > threshold)[0]
