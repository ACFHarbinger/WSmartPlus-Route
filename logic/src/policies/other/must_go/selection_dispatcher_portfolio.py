...
candidate "must-go" strategies. It supports robust consensus by returning either
...
Example:
    >>> from logic.src.policies.other.must_go.selection_dispatcher_portfolio import PortfolioDispatcher
...
@MustGoSelectionRegistry.register("dispatcher_portfolio")
class PortfolioDispatcher(IMustGoSelectionStrategy):
    """
