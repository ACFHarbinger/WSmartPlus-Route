...
Example:
    >>> from logic.src.policies.other.must_go.selection_pareto import ParetoFrontSelection
...
@MustGoSelectionRegistry.register("pareto_front")
class ParetoFrontSelection(IMustGoSelectionStrategy):
    """
