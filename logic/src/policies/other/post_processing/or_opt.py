...
@PostProcessorRegistry.register("or_opt")
class OrOptPostProcessor(IPostProcessor):
    """
    Or-opt post-processor that relocates chains of nodes within or between routes.
