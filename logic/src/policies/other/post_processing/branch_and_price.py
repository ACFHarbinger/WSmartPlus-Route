...
Fallback chain when the in-house solver is unavailable or fails:
    ...
    3. SetPartitioningPostProcessor with sp_n_perturbations=50 (tertiary)

Wall-clock budget is enforced at the post-processor level via bp_time_limit.
...
class BranchAndPricePostProcessor(IPostProcessor):
    ...
    def _solve_inhouse(
        ...
        **kwargs: Any,
        ...
        # post-processor-appropriate defaults.
        #
        # Note: use_exact_pricing defaults to True here because a post-processor
    ...
    def _solve_vrpy(  # noqa: C901
        ...
        **kwargs: Any,
        ...
        # that silently capped the post-processor's upside.
        if revenue_kg > 0:
            candidate_nodes = set()
            n_bins = dm.shape[0] - 1
