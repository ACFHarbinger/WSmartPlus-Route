...
@PostProcessorRegistry.register("cheapest_insertion")
class CheapestInsertionPostProcessor(IPostProcessor):
    """
    Cheapest insertion post-processor. Delegates to operators.repair.greedy_insertion
