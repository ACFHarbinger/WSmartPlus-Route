...
@PostProcessorRegistry.register("adaptive_large_neighborhood_search")
class AdaptiveLargeNeighborhoodSearchPostProcessor(IPostProcessor):
    """
    Adaptive Large Neighborhood Search (ALNS) post-processor.
