"""
Guided Local Search Post-Processor.
"""
...
@PostProcessorRegistry.register("guided_local_search")
class GuidedLocalSearchPostProcessor(IPostProcessor):
    """
    Guided Local Search (GLS) post-processor.
