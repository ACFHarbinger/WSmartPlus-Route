...
@PostProcessorRegistry.register("regret_k_insertion")
class RegretKInsertionPostProcessor(IPostProcessor):
    """
    Regret-k insertion post-processor. Delegates to operators.repair.regret.
