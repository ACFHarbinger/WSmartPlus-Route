"""
Set-Partitioning Post-Processor (Pool-Restricted Exact).
...
that lifts this restriction see BranchAndPricePostProcessor.
...
@PostProcessorRegistry.register("set_partitioning")
class SetPartitioningPostProcessor(IPostProcessor):
    """
    Pool-restricted exact set-partitioning post-processor.
