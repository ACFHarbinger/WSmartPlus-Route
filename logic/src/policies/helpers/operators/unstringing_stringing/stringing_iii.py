...
def apply_type_iii_s(route: List[int], x: int, i: int, j: int, k: int, current_load: float) -> List[int]:
    """
...
def apply_type_iii_s_profit(
    ...
    return apply_type_iii_s(route, x, i, j, k, current_load), float(delta_profit)
