"""
Pruning Module for Repair Operators.

This module implements the `prune_unprofitable_routes` function, a utility used
by VRPP repair operators (e.g., Greedy Blink, GENI) to filter out routes that
result in a net economic loss. This is crucial for VRPP variants where routes
...
Example:
    >>> from logic.src.policies.helpers.operators.repair._prune_routes import prune_unprofitable_routes
