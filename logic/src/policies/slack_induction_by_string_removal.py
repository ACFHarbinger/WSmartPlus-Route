"""
Slack Induction by String Removal (SISR) policy module.

Reference:
    Christiaens, J., & Vanden Berghe, G. (2020). Slack induction by string removal
    for vehicle routing problems. Transportation Science, 54(2), 417-433.
"""
