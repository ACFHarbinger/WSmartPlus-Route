        ...
        if len(routes_list) > 1:
            ...
            if len(donor_route) >= chosen_n + 2:
                if chosen_n == 2:
                    ...
                    receptor_position_1 = receptor_route.index(rsample(receptor_route[1:len(receptor_route)-1],1)[0])
                    donor_route.remove(donor_bin_1)
                    receptor_route.insert(receptor_position_1, donor_bin_1)

                    receptor_position_2 = receptor_route.index(rsample(receptor_route[1:len(receptor_route)-1],1)[0])
                    ...
                    receptor_position_3 = receptor_route.index(rsample(receptor_route[1:len(receptor_route)-1],1)[0])
                    ...
                    receptor_position_4 = receptor_route.index(rsample(receptor_route[1:len(receptor_route)-1],1)[0])
                    ...
                    receptor_position_5 = receptor_route.index(rsample(receptor_route[1:len(receptor_route)-1],1)[0])
