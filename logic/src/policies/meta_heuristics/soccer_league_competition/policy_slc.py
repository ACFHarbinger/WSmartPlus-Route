...
from logic.src.policies.meta_heuristics.soccer_league_competition.params import SLCParams
from logic.src.policies.meta_heuristics.soccer_league_competition.solver import SLCSolver
