...
from logic.src.policies.meta_heuristics.simulated_annealing_neighborhood_search.common.routes import (
    rearrange_part_route,
)
from logic.src.policies.meta_heuristics.simulated_annealing_neighborhood_search.operators.move import (
    move_1_route,
    move_2_routes,
...
from logic.src.policies.meta_heuristics.simulated_annealing_neighborhood_search.operators.swap import (
    swap_1_route,
    swap_2_routes,
...
from logic.src.policies.meta_heuristics.simulated_annealing_neighborhood_search.select import (
    add_bin,
...
def local_search(routes_list, removed_bins, distance_matrix, bins_cannot_removed, rng, np_rng):  # noqa: C901
    ...
    bins_consecutive = []
    chosen_n = 1
    if chosen_procedure.startswith("Move") or chosen_procedure.startswith("Swap"):
