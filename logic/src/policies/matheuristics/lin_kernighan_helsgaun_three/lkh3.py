...
from logic.src.policies.matheuristics.lin_kernighan_helsgaun_three.graph_augmentation import (
    augment_graph,
    decode_augmented_tour,
)
from logic.src.policies.matheuristics.lin_kernighan_helsgaun_three.load_tracker import (
    build_load_state,
    update_load_state_after_move,
)
from logic.src.policies.matheuristics.lin_kernighan_helsgaun_three.objective import (
...
from logic.src.policies.matheuristics.lin_kernighan_helsgaun_three.popmusic import (
    popmusic_candidates,
)
from logic.src.policies.matheuristics.lin_kernighan_helsgaun_three.tour_construction import (
    _double_bridge_kick,
    _initialize_tour,
    merge_tours_best,
)
from logic.src.policies.matheuristics.lin_kernighan_helsgaun_three.tour_improvement import (
...
def solve_lkh3_with_alns(
    ...
    from logic.src.policies.matheuristics.lin_kernighan_helsgaun_three.adaptive_large_neighborhood_search import (
        LKH3_ALNS,
    )
