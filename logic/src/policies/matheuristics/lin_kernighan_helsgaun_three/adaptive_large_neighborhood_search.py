...
class LKH3_ALNS:
    ...
    def solve(
        ...
        if native_prize_collecting:
            ...
            from logic.src.policies.matheuristics.lin_kernighan_helsgaun_three.lkh3 import solve_lkh3
        ...
        from logic.src.policies.matheuristics.lin_kernighan_helsgaun_three.lkh3 import compute_alpha_measures
    ...
    def _route_nodes(  # noqa: C901
        ...
        **Phase 2 Fix: Warm-Start Integration**
        ...
        from logic.src.policies.matheuristics.lin_kernighan_helsgaun_three.lkh3 import (
            solve_lkh3,
        )
